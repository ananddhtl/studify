...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="col-sm-8">
      ...
      @php
                                        $key = 'agent/agent_'.$id.'/'.$getfiles->filename;
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">
        ...
        <input type ="hidden" value="{{$folders->id}}">
      ...
      @endif
      @if($folders->foldername != '')
      <td><a href="{{url('/agent/get-document/'.$folders->id)}}">{{$folders->foldername}}</a></td>
      @else
      ...
      @php
                                        $key = 'agent/agent_'.$id.'/'.$folders->filename;
                                        $client = Storage::disk('s3')->getDriver()->getAdapter()->getClient();
                                        $bucket = 'studifynewbucket';
...
<!--end::Page-->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" id="width5">
        ...
        <form method="POST" action="{{url('/agent/create-document-folder')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
            @csrf
                               <div class="w-100">
                                <!--begin::Heading-->
