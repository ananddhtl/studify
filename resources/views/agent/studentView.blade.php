...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                ...
                <div
                    ...
                    <div class="card-body px-6 px-lg-10 px-xxl-15 py-20">
                        ...
                        <div class="stepper-nav">
                            ...
                            @if (request()->session()->get('status') == 'personal')
                                <div class="stepper-item current" id="personals" data-kt-stepper-element="nav"
                                    data-kt-stepper-action="step">
                                @else
                                    <div class="stepper-item" id="personals" data-kt-stepper-element="nav"
                                        data-kt-stepper-action="step">
                            @endif
                            <!--begin::Line-->
                        ...
                        @if (request()->session()->get('status') == 'address')
                            <div class="stepper-item current" id="addresss" data-kt-stepper-element="nav"
                                data-kt-stepper-action="step">
                            @else
                                <div class="stepper-item" id="addresss" data-kt-stepper-element="nav"
                                    data-kt-stepper-action="step">
                        @endif
                        <!--begin::Line-->
                        <div class="stepper-line w-40px "></div>
                    ...
                    @if (request()->session()->get('status') == 'language')
                        <div class="stepper-item current" id="languages" data-kt-stepper-element="nav"
                            data-kt-stepper-action="step">
                        @else
                            <div class="stepper-item" id="languages" data-kt-stepper-element="nav"
                                data-kt-stepper-action="step">
                    @endif
                    <!--begin::Line-->
                    <div class="stepper-line w-40px"></div>
                ...
                @if (request()->session()->get('status') == 'gpa')
                    <div class="stepper-item current" id="gpas" data-kt-stepper-element="nav"
                        data-kt-stepper-action="step">
                    @else
                        <div class="stepper-item" id="gpas" data-kt-stepper-element="nav"
                            data-kt-stepper-action="step">
                @endif
                <!--begin::Line-->
                <div class="stepper-line w-40px"></div>
            ...
            @if (request()->session()->get('status') == 'academic')
                <div class="stepper-item current" id="academics" data-kt-stepper-element="nav"
                    data-kt-stepper-action="step">
                @else
                    <div class="stepper-item" id="academics" data-kt-stepper-element="nav"
                        data-kt-stepper-action="step">
            @endif
            <!--begin::Line-->
            <div class="stepper-line w-40px"></div>
        ...
        @if (request()->session()->get('status') == 'contact')
            <div class="stepper-item current" id="contacts" data-kt-stepper-element="nav"
                data-kt-stepper-action="step">
            @else
    ...
    @if (request()->session()->get('status') == 'document')
        <div class="stepper-item current" id="documentss" data-kt-stepper-element="nav"
            data-kt-stepper-action="step">
        @else
...
<div class="card d-flex flex-row-fluid flex-center">
    ...
    @endif
    <!--begin::Wrapper-->
    <form method="POST" action="{{ url('student/update') }}" accept-charset="UTF-8"
        ...
        <div class="w-100">
            ...
            <div class="pb-10 pb-lg-12">
                ...
                <!--end::Title-->
                <!--begin::Notice-->
                <div class="text-muted fw-bold fs-6">Please enter your infomation and proceed to next step so we can
                    build your account
            ...
            <div class="row fv-row mb-10">
                ...
                <div class="col-6">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input name="first_name" id="first_name" class="form-control form-control-lg form-control-solid"
                ...
                <div class="col-6">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input name="last_name" id="last_name" class="form-control form-control-lg form-control-solid"
            ...
            <div class="fv-row mb-10">
                ...
                <input type="email" name="email" id="email"
                    class="form-control form-control-lg form-control-solid" value="{{ $student->email }}" readonly />
                @error('email')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                <!--end::Input-->
            ...
            <div class="fv-row mb-10">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <select name="gender" aria-label="Gender" data-control="select2" data-placeholder="Gender"
            ...
            <div class="row fv-row mb-10">
                ...
                <div class="col-6">
                    ...
                    <input type="date" id="ab_datepicker_dob" name="dob" placeholder="Select a date"
                        class="form-control mb-2" value="{{ $student->dob }}" readonly />

                    <?php } else { ?>
                    <input type="date" id="ab_datepicker_dob" name="dob" placeholder="Select a date"
                        class="form-control mb-2" value="" readonly />
                    @error('dob')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
...
<!--begin::Wrapper-->
@if ($address)
    <form method="POST" action="{{ url('student/updateAddress') }}" accept-charset="UTF-8"
        class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
        id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token"
            type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
        @csrf
            ...
            <div class="row fv-row mb-10">
                ...
                <div class="col-6">
                    ...
                    <input name="street_name" id="street_name"
                        class="form-control form-control-lg form-control-solid" value="{{ $address->street_name }}"
                        readonly />
                    @error('street_name')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
...
@else
    <form method="POST" action="{{ url('student/addAddress') }}" accept-charset="UTF-8"
        class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
        id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token"
            type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
        @csrf
        ...
        <div class="w-100">
            ...
            <div class="fv-row mb-10">
                ...
                <select name="countries_id" id="countries_id" aria-label="Select a Country" data-control="select2"
                    ...
                    <option value="">Select a Country...</option>
                    <option
                        data-kt-flag="https://www.advisebridge.com/resources/frontend_assets/member_assets/media/flags/afghanistan.svg"
            ...
            <div class="row fv-row mb-10">
                ...
                <div class="col-6">
                    ...
                    <!--begin::Input-->
                    <input name="street_name" id="street_name"
                        class="form-control form-control-lg form-control-solid" value="" readonly />
                    @error('street_name')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    <!--end::Input-->
...
<!--begin::Wrapper-->
@if ($language)
    <form method="POST" action="{{ url('student/updateLanguageScore') }}" accept-charset="UTF-8"
        class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
        id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token"
            type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
        @csrf
                ...
                <div class="row fv-row mb-10">
                    ...
                    <div class="col-6">
                        ...
                        <input name="speaking_score" id="speaking_score"
                            ...
                            value="{{ $language->speaking_score }}" onkeyup="return averageScoreCheck();" readonly />
                        <!--end::Input-->
                    ...
                    <div class="col-6">
                        ...
                        <input name="reading_score" id="reading_score"
                            class="form-control form-control-lg form-control-solid"
                            value="{{ $language->reading_score }}" onkeyup="return averageScoreCheck();" readonly />
                        <!--end::Input-->
                        @error('reading_score')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="row fv-row mb-10">
                    ...
                    <div class="col-6">
                        ...
                        <input name="writing_score" id="writing_score"
                            class="form-control form-control-lg form-control-solid"
                            value="{{ $language->writing_score }}" onkeyup="return averageScoreCheck();" readonly />
                        <!--end::Input-->
                        @error('writing_score')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="row fv-row mb-10">
                    ...
                    <div class="col-6">
                        ...
                        <input name="average_score" id="average_score"
                            class="form-control form-control-lg form-control-solid"
                            value="{{ $language->average_score }}" readonly />
                        <!--end::Input-->
                        @error('average_score')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-6">
                        ...
                        <input id="ab_datepicker_examdate" name="exam_date" placeholder="Select a date"
                            class="form-control mb-2" value="{{ $language->exam_date }}" readonly />
                        <!--end::Input-->
                        @error('exam_date')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
...
@else
    <!--begin::Wrapper-->
    <form method="POST" action="{{ url('student/addLanguageScore') }}" accept-charset="UTF-8"
        class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
        id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token"
            type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
        @csrf
                ...
                <div class="row fv-row mb-10">
                    ...
                    <div class="col-6">
                        ...
                        <input name="speaking_score" id="speaking_score"
                            ...
                            onkeyup="return averageScoreCheck();" readonly />
                        @error('speaking_score')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        <!--end::Input-->
...
<!--begin::Wrapper-->
<!--begin::Wrapper-->
<form method="POST" action="{{ url('student/updateGpaScore') }}" accept-charset="UTF-8"
    class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
    id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token"
        type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
    @csrf
    ...
    <div class="w-100">
        ...
        <div class=" fv-row mb-10">
            ...
            <input name="gpa_score" id="gpa_total" class="form-control form-control-lg form-control-solid"
                value="{{ $student->gpa_score }}" readonly />
            @error('gpa_score')
                <span class="text-danger">{{ $message }}</span>
            @enderror
            <!--end::Input-->
...
@if (count($academics) != 0)
    <form method="POST" action="{{ url('student/updateacademic') }}" accept-charset="UTF-8"
        class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
        id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token"
            type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
        @csrf
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>City Name :
                                                                    <input type="text"
                                                                        ...
                                                                        class="form-control edu_city_name" readonly />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Passed Year :
...
@else
    <form method="POST" action="{{ url('student/addacademic') }}" accept-charset="UTF-8"
        class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
        id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token"
            type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
        @csrf
...
<!--begin::Wrapper-->
@if ($contact)
    <form method="POST" action="{{ url('student/updateContact') }}"
        class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
        id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token"
            type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
        @csrf
            ...
            <div class="row fv-row mb-10">
                ...
                <div class="col-6">
                    ...
                    <input name="contact_name" id="e_contact_name"
                        class="form-control form-control-lg form-control-solid" value="{{ $contact->contact_name }}"
                        readonly />
                    <!--end::Input-->
                    @error('contact_name')
                        <span class="text-danger">{{ $message }}</span>
                ...
                <div class="col-6">
                    ...
                    <input name="relationship" id="e_relationship"
                        class="form-control form-control-lg form-control-solid" value="{{ $contact->relationship }}"
                        readonly />
                    <!--end::Input-->
                    @error('relationship')
                        <span class="text-danger">{{ $message }}</span>
            ...
            <div class="row fv-row mb-10">
                ...
                <div class="col-6">
                    ...
                    <input name="contact_phone" id="e_contact_phone"
                        class="form-control form-control-lg form-control-solid" value="{{ $contact->phone_number }}"
                        readonly />
                    <!--end::Input-->
                    @error('contact_phone')
                        <span class="text-danger">{{ $message }}</span>
...
@else
    <form method="POST" action="{{ url('student/addContact') }}"
        class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
        id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token"
            type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
        @csrf
...
<!--begin::Wrapper-->
<!--begin::Wrapper-->
<form method="POST" action="{{ url('/student/upload-documents') }}"
                    ...
                    <label for="images" class="drop-container">
                        ...
                        @if (count($passportimage) != '0')
                            @foreach ($passportimage as $passportimages)
                                <img onclick="onClick(this)" data-toggle="modal" data-target="#exampleModalCenter"
                                    src="{{ asset('public/StudentPassportImage/' . $passportimages->image) }}"
                                    width="100" height="100">
                                <a href="{{ url('student/delete-passport/' . $passportimages->id) }}"
            ...
            <div class="form-group row rounded border p-10">
                <div class="col-lg-12">
                    <label for="images" class="drop-container">
                        ...
                        <img onclick="onClick(this)" data-toggle="modal" data-target="#exampleModalCenter"
                            src="{{ asset('public/StudentEnglishCertificate/' . $student->english_certificate) }}"
                            width="100" height="100">
                    </label>
                    ...
                    <label for="images" class="drop-container">
                        ...
                        @if (count($marksheet) != '0')
                            @foreach ($marksheet as $marksheets)
                                <img onclick="onClick(this)" data-toggle="modal" data-target="#exampleModalCenter"
                                    src="{{ asset('public/StudentMarksheetImage/' . $marksheets->marksheet) }}"
                                    width="100" height="100">
                    ...
                    <label for="images" class="drop-container">
                        ...
                        @if (count($recommendation) != '0')
                            @foreach ($recommendation as $recommendations)
                                <img onclick="onClick(this)" data-toggle="modal" data-target="#exampleModalCenter"
                                    src="{{ asset('public/StudentRecommandation/' . $recommendations->recommand) }}"
                                    width="100" height="100">
                    ...
                    <label for="images" class="drop-container">
                        ...
                        @if (count($financial) != '0')
                            @foreach ($financial as $financials)
                                <img onclick="onClick(this)" data-toggle="modal" data-target="#exampleModalCenter"
                                    src="{{ asset('public/StudentFinanicalImage/' . $financials->financial_images) }}"
                                    width="100" height="100">
                                <a href="{{ url('student/delete-financials/' . $financials->id) }}"
                                    id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                        @endif
                    </label>
                    ...
                    <label for="images" class="drop-container">
                        ...
                        @if (count($other) != '0')
                            @foreach ($other as $others)
                                <img onclick="onClick(this)" data-toggle="modal" data-target="#exampleModalCenter"
                                    src="{{ asset('public/StudentOther/' . $others->other_image) }}" width="100"
                                    height="100">
...
<form method="POST" action="{{ url('/student/updateSignature') }}" accept-charset="UTF-8"
    class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
    id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token"
        type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
    @csrf
