        ...
        <form method="POST" action="{{ url('/agent/updatestudent') }}" accept-charset="UTF-8"
            ...
            <div class="w-100">
                ...
                <div class="fv-row">
                    ...
                    <img src="{{ asset('StudentImage/' . $user->student_img) }}" alt="Simply Easy Learning"
                        width="200" height="80">
                ...
                <div class="col-lg-12">
                    ...
                    @if (count($passportimage) != '0')
                        @foreach ($passportimage as $passportimages)
                            ...
                            @if ($ext == 'pdf')
                                <div class="imag-boxf"><iframe
                                        src="{{ asset('StudentPassportImage/' . $passportimages->image) }}"
                    ...
                    <label for="images" class="drop-container">
                        ...
                        <div class="dropzone" id="dropzone_language">
                            ...
                            @if ($student)
                                ...
                                @if ($ext == 'pdf')
                                    <div class="imag-boxf"><iframe
                                            src="{{ asset('StudentEnglishCertificate/' . $student->english_certificate) }}"
                ...
                <div class="col-lg-12">
                    ...
                    @if (count($marksheet) != '0')
                        @foreach ($marksheet as $marksheets)
                            ...
                            @if ($ext == 'pdf')
                                <div class="imag-boxf"><iframe
                                        src="{{ asset('StudentMarksheetImage/' . $marksheets->marksheet) }}"
                                        width="100" height="150"></iframe>
                                @else
            ...
            <div class="form-group row rounded border p-10">
                <div class="col-lg-12">
                    ...
                    @if ($student)
                        ...
                        @if ($ext == 'pdf')
                            <div class="imag-boxf"><iframe
                                    src="{{ asset('StudentResume/' . $student->resume) }}" width="100"
                                    height="150"></iframe>
                            @else
                ...
                <div class="col-lg-12">
                    ...
                    @if (count($recommendation) != '0')
                        @foreach ($recommendation as $recommendations)
                            ...
                            @if ($ext == 'pdf')
                                <div class="imag-boxf"><iframe
                                        src="{{ asset('StudentRecommandation/' . $recommendations->recommand) }}"
                                        width="100" height="150"></iframe>
                                @else
                ...
                <div class="col-lg-12">
                    ...
                    @if (count($financial) != '0')
                        @foreach ($financial as $financials)
                            ...
                            @if ($ext == 'pdf')
                                <div class="imag-boxf"><iframe
                                        src="{{ asset('StudentFinanicalImage/' . $financials->financial_images) }}"
                                        width="100" height="150"></iframe>
                                @else
                            ...
                            <a href="{{ url('agent/delete-financials/' . $financials->id) }}" id="cross"><i
                                    class="fa fa-times" aria-hidden="true"></i></a>
                        @endforeach
                    @endif
                ...
                <div class="col-lg-12">
                    ...
                    @if (count($other) != '0')
                        @foreach ($other as $others)
                            ...
                            @if ($ext == 'pdf')
                                <div class="imag-boxf"><iframe
                                        src="{{ asset('StudentOther/' . $others->other_image) }}"
                                        width="100" height="150"></iframe>
                                @else
                                    <img src="{{ asset('StudentOther/' . $others->other_image) }}"
                                        width="100" height="100">
                            @endif
