...
@endif
                    ...
                    <div class="card d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px w-xxl-400px me-9">
                        ...
                        <div class="card-body px-6 px-lg-10 px-xxl-15 py-20">
                            ...
                            <div class="stepper-nav">
                                ...
                                <div class="stepper-item current" id="personal_agent" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                   @else
                                <div class="stepper-item" id="personal_agent" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                ...
                                <div class="stepper-item current" id="address_agent" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                @else
                                <div class="stepper-item" id="address_agent" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                @endif
                                    <!--begin::Line-->
                                    <div class="stepper-line w-40px"></div>
                                    <!--end::Line-->
                                ...
                                <div class="stepper-item current" id="language_agent"  data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                @else
                                <div class="stepper-item" id="language_agent"data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                @endif
                                ...
                                <div class="stepper-item current" id="gpa_agent"  data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                 @else
                                <div class="stepper-item" id="gpa_agent" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                 @endif
                                    <!--begin::Line-->
                                    <div class="stepper-line w-40px"></div>
                                    <!--end::Line-->
                                ...
                                <div class="stepper-item current" id="academic_agent"data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                @else
                                <div class="stepper-item " id="academic_agent"data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                ...
                                <div class="stepper-item current" id="contact_agent" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                @else
                                ...
                                <div class="stepper-item current" id="document_agent" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                @else
                                <div class="stepper-item" id="document_agent" data-kt-stepper-element="nav" data-kt-stepper-action="step">
  ...
  @endif
                            ...
                            <!--begin::Wrapper-->
                            @if($user)
                            <form method="POST" action="{{url('/agent/updatestudent')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                          @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="first_name" id="first_name" class="form-control form-control-lg form-control-solid" value="{{$user->first_name}}" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="last_name" id="last_name" class="form-control form-control-lg form-control-solid" value="{{$user->last_name}}" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="email" name="email" id="email" class="form-control form-control-lg form-control-solid" value="{{$user->email}}" />
                                    <!--end::Input-->
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            <input type="text" name="phone" id="phone" class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="{{$user->phone}}" />
                                        </div>
                                    </div>
                                </div>
                                <!--end::Input group-->
                           ...
                           <option value="others" >
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="date" id="ab_datepicker_dob" name="dob" placeholder="Select a date" class="form-control mb-2" value="{{$user->dob}}" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" id="birth_place_country" name="country" placeholder="Enter the Birth Place Country" class="form-control mb-2" value="{{$user->country}}" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                ...
                                <select class="form-select" id="Crd" name="insitution_id" aria-label="Default select example">
        <option selected>Open this select menu</option>
        @foreach($institution as $institutions)
        <option value="{{$institutions->id}}" <?=$institutions->id == $user->insitution_id ? ' selected="selected"' : '';?>>{{$institutions->universirty_name}}</option>
        @endforeach
        </select>                
 ...
 <img src="{{asset('public/StudentImage/'.$user->student_img)}}" alt="Simply Easy Learning" width="200"
         height="80">
                            ...
                            @else
                      <form method="POST" action="{{url('/agent/studentRegister')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                          @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="first_name" id="first_name" class="form-control form-control-lg form-control-solid" value="" />
                                        @error('first_name')
                                ...
                                @enderror
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="last_name" id="last_name" class="form-control form-control-lg form-control-solid" value="" />
                                        @error('last_name')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                        <!--end::Input-->
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="email" name="email" id="email" class="form-control form-control-lg form-control-solid" value="" />
                                    @error('email')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                    <!--end::Input-->
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="date" id="ab_datepicker_dob" name="dob" placeholder="Select a date" class="form-control mb-2" value="" />
                                        @error('dob')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                        <!--end::Input-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" id="birth_place_country" name="country" placeholder="Enter the Birth Place Country" class="form-control mb-2" value="" />
                                        @error('country')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                        <!--end::Input-->
        ...
        @endforeach
                        ...
                        @endif
                            <!--begin::Wrapper-->
                            @if($address)
                            <form method="POST" action="{{url('agent/updateAddress')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                           @csrf
                            <input type="hidden" name="id" value="{{$user->id}}">
                            <div class="w-100">
                                <!--begin::Heading-->
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="street_name" id="street_name" class="form-control form-control-lg form-control-solid" value="{{$address->street_name}}" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="city_name" id="city_name" class="form-control form-control-lg form-control-solid" value="{{$address->city}}" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input name="province_state" id="province_state" class="form-control form-control-lg form-control-solid" value="{{$address->state}}" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="zip_code" id="zip_code" class="form-control form-control-lg form-control-solid" value="{{$address->zipcode}}" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                            ...
                            @else 
<form method="POST" action="{{url('agent/addAddress')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                           @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="street_name" id="street_name" class="form-control form-control-lg form-control-solid" value="" />
                                      @error('street_name')
                                <span class="text-danger">{{$message}}</span>
                                @enderror  <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="city_name" id="city_name" class="form-control form-control-lg form-control-solid" value="" />
                                        @error('city_name')
                                <span class="text-danger">{{$message}}</span>
                                @enderror<!--end::Input-->
                                    </div>
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input name="province_state" id="province_state" class="form-control form-control-lg form-control-solid" value="" />
                                ...
                                @enderror<!--end::Input-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="zip_code" id="zip_code" class="form-control form-control-lg form-control-solid" value="" />
                                      @error('zip_code')
                                <span class="text-danger">{{$message}}</span>
                                @enderror  <!--end::Input-->
                                    </div>
                        ...
                        @endif
                            ...
                            <!--begin::Wrapper-->
                            @if($language)
                            <form method="POST" action="{{url('agent/updateLanguageScore')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                          @csrf
                            <input type="hidden" name="id" value="{{$user->id}}">
                            <div class="w-100">
                                <!--begin::Heading-->
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="speaking_score" id="speaking_score" class="form-control form-control-lg form-control-solid" value="{{$language->speaking_score}}" onkeyup="return averageScoreCheck();" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="reading_score" id="reading_score" class="form-control form-control-lg form-control-solid" value="{{$language->reading_score}}" onkeyup="return averageScoreCheck();" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="writing_score" id="writing_score" class="form-control form-control-lg form-control-solid" value="{{$language->writing_score}}" onkeyup="return averageScoreCheck();" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="listening_score" id="listening_score" class="form-control form-control-lg form-control-solid" value="{{$language->listening_score}}" onkeyup="return averageScoreCheck();" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="average_score" id="average_score" class="form-control form-control-lg form-control-solid" value="{{$language->average_score}}" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input id="ab_datepicker_examdate" name="exam_date" placeholder="Select a date" class="form-control mb-2" value="{{$language->exam_date}}" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                            ...
                            @else
<form method="POST" action="{{url('agent/addLanguageScore')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                          @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="speaking_score" id="speaking_score" class="form-control form-control-lg form-control-solid" value="" onkeyup="return averageScoreCheck();" />
                                ...
                                @enderror <!--end::Input-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="reading_score" id="reading_score" class="form-control form-control-lg form-control-solid" value="" onkeyup="return averageScoreCheck();" />
                                        @error('reading_score')
                                <span class="text-danger">{{$message}}</span>
                                @enderror<!--end::Input-->
                                    </div>
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="writing_score" id="writing_score" class="form-control form-control-lg form-control-solid" value="" onkeyup="return averageScoreCheck();" />
                                       @error('writing_score')
                                <span class="text-danger">{{$message}}</span>
                                @enderror <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="listening_score" id="listening_score" class="form-control form-control-lg form-control-solid" value="" onkeyup="return averageScoreCheck();" />
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="average_score" id="average_score" class="form-control form-control-lg form-control-solid" value="" />
                                      @error('average_score')
                                <span class="text-danger">{{$message}}</span>
                                @enderror  <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input id="ab_datepicker_examdate" name="exam_date" placeholder="Select a date" class="form-control mb-2" value="" />
                                      @error('exam_date')
                                <span class="text-danger">{{$message}}</span>
                                @enderror  <!--end::Input-->
                                    </div>
                        ...
                        <div id="gpa_info" class="current" data-kt-stepper-element="content">
                            ...
                            <form method="POST" action="{{url('agent/updateGpaScore')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                            ...
                            <div class="w-100">
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <select name="gpa_scale" id="gpa_id" aria-label="Select scale" data-control="select2" data-placeholder="Select scale ...." class="form-select form-select-solid form-select-lg fw-bold">
                                        ...
                                        @if($user)
                                         @if($user->gpa_scale == '0-4')                                                                                           <option value="1" >1-100</option>
                                ...
                                <div class=" fv-row mb-10">
                                    ...
                                    <!--begin::Input-->
                                    @if($user)
                                    <input name="gpa_score" id="gpa_total" class="form-control form-control-lg form-control-solid" value="{{$user->gpa_score}}" />
                                    @else
                                    <input name="gpa_score" id="gpa_total" class="form-control form-control-lg form-control-solid" value="" />
                                 @error('gpa_score')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                    @endif
                            ...
                            <option  value="{{ $country->id }}" {{ ( $country->id == $academic->country) ? 'selected' : '' }}>{{$country->country_name}}</option>
                                    ...
                                    @endforeach    
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>City Name : 
                                                                                        <input type="text" value="{{$academic->city}}" name="city[]" placeholder="City Name" class="form-control edu_city_name"/>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Passed Year : 
                                                                                        
                                                                                     <input id="ab_datepicker_examdate" name="passed_year[]" placeholder="Select a date" class="form-control mb-2 flatpickr-input active flat_datepicker" value="{{$academic->passed_year}}" />
                                                                                    </td>
                                                                                    <td>Level of study :
                        ...
                        @endif
                            ...
                            <!--begin::Wrapper-->
                            @if($contact)
                                 <form method="POST" action="{{url('agent/updateContact')}}" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                            @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="contact_name" id="e_contact_name" class="form-control form-control-lg form-control-solid" value="{{$contact->contact_name}}" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="relationship" id="e_relationship" class="form-control form-control-lg form-control-solid" value="{{$contact->relationship}}" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="contact_phone" id="e_contact_phone" class="form-control form-control-lg form-control-solid" value="{{$contact->phone_number}}" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="contact_email" id="e_contact_email" class="form-control form-control-lg form-control-solid" value="{{$contact->email}}" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                            ...
                            <form method="POST" action="{{url('agent/addContact')}}" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                           @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="contact_name" id="e_contact_name" class="form-control form-control-lg form-control-solid" value="" />
                                       @error('contact_name')
                                <span class="text-danger">{{$message}}</span>
                                @enderror <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="relationship" id="e_relationship" class="form-control form-control-lg form-control-solid" value="" />
                                        @error('relationship')
                                <span class="text-danger">{{$message}}</span>
                                @enderror<!--end::Input-->
                                    </div>
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="contact_phone" id="e_contact_phone" class="form-control form-control-lg form-control-solid" value="" />
                                      @error('contact_phone')
                                <span class="text-danger">{{$message}}</span>
                                @enderror  <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="contact_email" id="e_contact_email" class="form-control form-control-lg form-control-solid" value="" />
                                      @error('contact_email')
                                <span class="text-danger">{{$message}}</span>
                                @enderror  <!--end::Input-->
                                    </div>
                   ...
                   @if(request()->session()->get('status') == 'document')
                       ...
                       <div id="documents_info" data-kt-stepper-element="content">
                        @endif
                            <!--begin::Wrapper-->
                            <!--begin::Wrapper-->
                            <form method="POST" action="{{url('/agent/upload-documents')}}"  class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework form-image-passporter" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                            @csrf
                ...
                <div class="alert alert-danger">
                    <ul>
                        ...
                        <li>Files must not be greater than 5Mb. </li>
                        @endforeach
                    </ul>
                </div>
            @endif
...
<input type="hidden" name="student_id" value="{{$student->id}}">
                                <div class="fv-row mb-10">
                                    <label class="form-label required">Passport (PNG,JPG,PDF) (Choose Multiple)</label><br>
                     ...
                     <input type="file" id="images" name="passport[]" multiple >
                                            ...
                                            @if(count($passportimage) != '0')
                                                 ...
                                                 @php $ext = pathinfo($passportimages->image, PATHINFO_EXTENSION); @endphp
    @if($ext == 'pdf')
    <div class="imag-boxf"><iframe src="{{asset('public/StudentPassportImage/'.$passportimages->image)}}" width="100" height="100"></iframe>
    @else
    <img src="{{asset('public/StudentPassportImage/'.$passportimages->image)}}" width="100" height="100">
      @endif
                            <a href="{{url('agent/delete-passport/'.$passportimages->id)}}" id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                            @endif
                                            </div>
                                    </div>
                                ...
                                <div class="fv-row mb-10">
                                    <label class="form-label required">English Language Proficiency Certificate</label><br>
                                    @if($errors->has('english_certificate'))
    <div class="error" style="color:red;">{{ $errors->first('english_certificate') }}</div>
@endif
                                    <div class="form-group row rounded border p-10">
                                        <div class="col-lg-12">
                                            <label for="images" class="drop-container">
                                                ...
                                                <div class="dropzone" id="dropzone_language">
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <input type="file" id="images" name="english_certificate" ><br>
                                        ...
                                        @if($student)
                                        @php $ext = pathinfo($student->english_certificate, PATHINFO_EXTENSION); @endphp
    @if($ext == 'pdf')
    <div class="imag-boxf"><iframe src="{{asset('public/StudentEnglishCertificate/'.$student->english_certificate)}}" width="100" height="150"></iframe>
    @else
                                            ...
                                            <label for="images" class="drop-container">
                                                <div class="dropzone" id="dropzone_marksheet">
                                                 ...
                                                 @if(count($marksheet) != '0')
                                                  ...
                                                  @php $ext = pathinfo($marksheets->marksheet, PATHINFO_EXTENSION); @endphp
    @if($ext == 'pdf')
    <div class="imag-boxf"><iframe src="{{asset('public/StudentMarksheetImage/'.$marksheets->marksheet)}}" width="100" height="150"></iframe>
    @else
    <img src="{{asset('public/StudentMarksheetImage/'.$marksheets->marksheet)}}" width="100" height="100">
      @endif

                            <a href="{{url('agent/delete-marksheet/'.$marksheets->id)}}" id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                            @endif
                                ...
                                <div class="fv-row mb-10">
                                    <label class="form-label required">CV/ Resume</label><br>
                                    ...
                                    <div class="form-group row rounded border p-10">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="dropzone" id="dropzone_cv">
                                                ...
                                                @if($student)
                                                @php $ext = pathinfo($student->resume, PATHINFO_EXTENSION); @endphp
    @if($ext == 'pdf')
    <div class="imag-boxf"><iframe src="{{asset('public/StudentResume/'.$student->resume)}}" width="100" height="150"></iframe>
    @else
                                    ...
                                    <div class="form-group row rounded border p-10">
                                        <div class="col-lg-12">
                                             <label for="images" class="drop-container">
                                                 ...
                                                 @php $ext = pathinfo($recommendations->recommand, PATHINFO_EXTENSION); @endphp
    @if($ext == 'pdf')
    <div class="imag-boxf"><iframe src="{{asset('public/StudentRecommandation/'.$recommendations->recommand)}}" width="100" height="150"></iframe>
    @else
    <img src="{{asset('public/StudentRecommandation/'.$recommendations->recommand)}}" width="100" height="100">
      @endif

                            <a href="{{url('agent/delete-recommendations/'.$recommendations->id)}}" id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                            @endif
                                        ...
                                        <div class="col-lg-12">
                                            <label for="images" class="drop-container">
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <div class="ms-4">
                                                            <h3 class="fs-5 fw-bolder text-gray-900 mb-1">Drop files here or click to upload</h3>
                                   <input type="file" id="images" name="financialDoc[]" multiple >                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                </div></label><br>
                                                 @if(count($financial) != '0')
                                                @foreach($financial as $financials)
                                                @php $ext = pathinfo($financials->financial_images, PATHINFO_EXTENSION); @endphp
    @if($ext == 'pdf')
    <div class="imag-boxf"><iframe src="{{asset('public/StudentFinanicalImage/'.$financials->financial_images )}}" width="100" height="150"></iframe>
    @else
    <img src="{{asset('public/StudentFinanicalImage/'.$financials->financial_images )}}" width="100" height="100">
      @endif

                            <a href="{{url('agent/delete-financials/'.$financials->id)}}" id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                            @endif
                                        ...
                                        <div class="col-lg-12">
                                            <label for="images" class="drop-container">
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <div class="ms-4">
                                                            <h3 class="fs-5 fw-bolder text-gray-900 mb-1">Drop files here or click to upload</h3>
                              <input type="file" id="images" name="other[]" multiple >                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                </div></label><br>
                                                 @if(count($other) != '0')
                                @foreach($other as $others)
                                @php $ext = pathinfo($others->other_image, PATHINFO_EXTENSION); @endphp
    @if($ext == 'pdf')
    <div class="imag-boxf"><iframe src="{{asset('public/StudentOther/'.$others->other_image)}}" width="100" height="150"></iframe>
    @else
    <img src="{{asset('public/StudentOther/'.$others->other_image)}}" width="100" height="100">
      @endif
                            <a href="{{url('agent/delete-other/'.$others->id)}}" id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                            @endif
                        ...
                        <div id="signature_info" data-kt-stepper-element="content">
                            ...
                            <!--begin::Wrapper-->
                            <!--begin::Wrapper-->
                            <form method="POST" action="{{url('agent/updateSignature')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                           @csrf
