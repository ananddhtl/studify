...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="card card-flush mt-6 mt-xl-9">
                ...
                <div class="card-header mt-5">
                    ...
                    <div class="card-toolbar my-1">
                        ...
                        <div class="me-6 my-1" style="display: none;">
                            <select id="kt_filter_year" name="year" data-control="select2" data-hide-search="true"
                                ...
                                <option value="All" selected="selected" data-select2-id="select2-data-2-o38j">All
                                    time</option>
                                ...
                                dir="ltr" data-select2-id="select2-data-1-38te" style="width: 100%;"><span
                        ...
                        <div class="me-4 my-1" style="display: none;">
                            <select id="kt_filter_orders" name="orders" data-control="select2" data-hide-search="true"
                                ...
                                <option value="All" selected="selected" data-select2-id="select2-data-4-ph97">All
                                    Status</option>
                                ...
                                dir="ltr" data-select2-id="select2-data-3-84nm" style="width: 100%;"><span
                                    class="selection"><span
                                        class="select2-selection select2-selection--single w-125px form-select form-select-solid form-select-sm"
                                        role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                        ...
                                        aria-controls="select2-kt_filter_orders-container"><span
                                            ...
                                            role="textbox" aria-readonly="true" title="All Status">All
                    ...
                    <div class="card-title flex-column">
                        ...
                        <a href="{{ url('agent/new/member/add') }}" class="btn btn-primary" id="add">Add New
                            Student</a>
                                ...
                                @foreach ($member as $members)
                                    <tr>
                                                ...
                                                <div class="me-5 position-relative ">
                                                    ...
                                                    <a href="#">
                                                        <div class="symbol symbol-65px symbol-circle ">
                                                            <img src="{{ asset('StudentImage/' . $members->student_img) }}"
                                        ...
                                        <td>
                                            ...
                                            <div class="">
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-primary d-block ">{{ $members->first_name }}</a>
                                        ...
                                        <td>{{ $members->phone }}</td>
                                        @php
                                            $values = App\Models\studentWorkflow::where(['student_id' => $members->id])
                                                ->where(['status' => '2'])
                                                ->orderBy('id', 'DESC')
                                                ->first();
                                            if ($values != '') {
                                                if ($values) {
                                                    $workflow = App\Models\workflow::where([
    ...
    background-color: #F1FAFF !important;
                                                    ...
                                                    <ul class="dropdown-menu"style="top: 40px !important;"
                                                        ...
                                                        <li><a
                                                                href="{{ url('/agent/student-view/' . $members->id) }}">View</a>
                                                        </li>
                                                        <li><a
                                                                href="{{ url('/agent/check-application/' . $members->id) }}">Edit</a>
                                                        </li>
                                                        <li><a
                                                                href="{{ url('/agent/student/delete/' . $members->id) }}">Delete</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <!--end::Menu-->
