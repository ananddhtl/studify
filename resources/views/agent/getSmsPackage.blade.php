...
@foreach($package as $packages)
    ...
    margin-bottom: 8px;">
                                ...
                                <p style="font-size:13px; margin:0px;">
                                    ...
                                    SMS Limit: {{$packages->sms_limit}}                                    </p>
                               
                                    <p style="font-size:26px; margin:0px; color:green; font-weight: 700;">AUD{{$packages->package_price}}</p>
                                ...
                                <div class="fix"><a class="serach-btn" href="{{url('/agent/sms-package/payment/'.$packages->id)}}" style="border: 0px; margin-top: 5px; display: block; padding: 10px;" id="nw-add">Buy</a>
    ...
    margin-bottom: 8px;">
                                ...
                                <p style="font-size:13px; margin:0px;">
                                    <i style="font-size:12px" class="fas"></i>
                                    SMS Limit: {{$nepalpackages->sms_limit}}                                 </p>
                               
                                    <p style="font-size:26px; margin:0px; color:green; font-weight: 700;">Rs{{$nepalpackages->package_price}}</p>
                                ...
                                <div class="fix"><a class="serach-btn" href="{{url('/agent/sms-package/payment/'.$nepalpackages->id)}}" style="border: 0px; margin-top: 5px; display: block; padding: 10px;" id="nw-add">Buy</a>
