        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form 
                            role="form" 
                            action="{{route('/agent/stripe.post')}}" 
                            method="post" 
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                              ...
                              @if($coupondiscount->coupon_discount_type == 'Percentage(%)')
                                @php  $couponprize  = $package->package_monthly * $coupondiscount->coupon_amount / 100 ;
                               ...
                               @php $amount = $package->package_monthly; @endphp
                                ...
                                @if($coupondiscount)
                              @if($coupondiscount->coupon_discount_type == 'Percentage(%)')
                                @php  $couponprize  = $package->package_yearly * $coupondiscount->coupon_amount / 100 ;
