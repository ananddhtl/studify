...
<div class="row">
    ...
    <h2 class="sem">Get more SMS please click on this link.<a href="{{url('agent/sms-package')}}" style="color: blue"> Get More?</a></h2>
    <h2 style="float:right;" class="sem">Remaining SMS:<a href="{{url('agent/sms-package')}}" style="color: blue">{{$remaining}}</a></h2>
...
<div class="use">
<div class="list">
    @if($smsprofiles->member_type == 'Staff')
    @php
   $data = App\Models\addRole::where(['phone' => $smsprofiles->reciever])->first();
@endphp 
...
<div class="text">
 ...
 <span>{{ \Carbon\Carbon::parse($smsprofiles->created_at)->format('d F Y') }}</span>
  ...
  @elseif($smsprofiles->member_type == 'Student')
  @php
...
<form id="First" method="POST" action="{{url('/agent/send-sms')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
@csrf                          
<div class="w-100">
                       ...
                       <div class="row fv-row mb-6">
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="phone" id="phone" class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="{{$agentprofile->phone}}">
                                                                                <!--end::Input-->
                                    </div>
                                 <div class="col-6">
...
<form id="Second" method="POST" action="{{url('/agent/send-group-smss')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
      @csrf
                  <div class="w-100">
