  ...
  @endif
                          ...
                          @csrf
                           ...
                           <option value="others" >
                                ...
                                <select class="form-select getCourse" id="Crd" name="insitution_id" aria-label="Default select example">
        ...
        <select class="form-select Course" id="course" name="course_id" aria-label="Default select example">
        <option selected>Open this select menu</option>
                          ...
                          @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="pb-10 pb-lg-12">
                                    ...
                                    <!--begin::Notice-->
                                    <div class="text-muted fw-bold fs-6">Please enter your infomation and proceed to next step so we can build your account
                                    <br><br>  @if(session()->has('emailexit'))
...
<form method="POST" action="{{url('agent/addLanguageScore')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                        ...
                        @endif
                            ...
                            <form method="POST" action="{{url('agent/updateacademic')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                            @csrf
                            ...
                            @else
                            <form method="POST" action="{{url('agent/addacademic')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                            @csrf
                            <input type="hidden" name="tab" value="academic_info">
                            <div class="w-100">
                                <!--begin::Heading-->
                    ...
                    success: function (result) {
                        ...
                        $.each(result.states, function (key, value) {
                            $("#course").append('<option value="' + value
                                .id + '">' + value.c_name +" ("+value.type +")"  + '</option>');
                        });
                    }
                });
            });
