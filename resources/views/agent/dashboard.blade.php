...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" style="height: 80vh;">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="pb-10 pb-lg-12" id="dasbb" style="margin-bottom: -6%;">
                <h2 class="sem">Upgrade your current package plans.<a href="{{ url('agent/select-package') }}"
                        style="color: blue"> Get More Features?</a></h2>
            </div> <br><br>
    ...
    color: #a7c952; text-align: center;margin-bottom: 30px;">
                                                <b>Package Info</b></p>
                                            <h5 class="coupon_name" style="font-size:18px; margin:5px 0px 0px 0px;"
                                                readonly>{{ $package->package_name }}</h5>

                                            <p style="font-size:16px; margin:0px; color:#838181;" readonly>
                                                {{ $package->package_title }}</p>

                                            <p
                                                style="font-size:14px; margin:0px; color: #838181;
    font-weight: 500;">
                               ...
                               "class="fa fa-clock-o"
                                            ...
                                            <div class="timeuse">
                                                <div class="used"><label for="start">Start date:</label>
                                                    ...
                                                    <input type="text" id="start" name="trip-start"
                                                        value="{{ $member->package_start_date }}" min="2018-01-01"
                                                        max="2018-12-31" readonly>
                                                </div>
                                                <div class="used1">
                                                    <label for="start">End date:</label>

                                                    <input type="text" id="End" name="trip-start"
                                                        value="{{ $member->package_end_date }}" min="2018-01-01"
                                                        max="2018-12-31" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="features">
                                            <p
                                                style="margin: 0px; font-size: 20px;
    color: #a7c952; text-align: center; margin-bottom: 30px;">
                                                <b>Package features</b></p>

                                            @php
                                                $packagefeature = App\Models\addPackage::where([
                                                    'package_id' => $id,
                                                ])->get();
                                                $feature = [];
                                            @endphp
                                            ...
                                            <ul class="check-element">
                                                @if (array_search('sms', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">SMS</span>
                                                    </li>
                                                @else
                                                ...
                                                @if (array_search('email', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Email</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Email</span>
                                                ...
                                                @if (array_search('calender', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Calender</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Calender</span>
                                                ...
                                                @if (array_search('rolePermission', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Role Permission</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Role Permission</span>
                                                ...
                                                @if (array_search('leadManage', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Lead Manage</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Lead Manage</span>
                                                ...
                                                @if (array_search('documentManage', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Document Manage</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Document Manage</span>
                                                ...
                                                @if (array_search('application', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Application</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Application</span>
                                                ...
                                                @if (array_search('account', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Account</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Account</span>
                                                ...
                                                @if (array_search('workflow', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Workflow</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Workflow</span>
                                                ...
                                                @if (array_search('news', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">News</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">News</span>
                                                ...
                                                @if (array_search('support', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Support</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Support</span>
                                                ...
                                                @if (array_search('sampledocument', $strreplace) != '')
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Sample Document</span>
                                                    </li>
                                                @else
                                                    <li><i class="fa fa-square-o" aria-hidden="true"></i>
                                                        <span data-v-7c4fa3d1="" class="ml-3">Sample Document</span>
