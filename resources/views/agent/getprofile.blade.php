            ...
            <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap">
                            ...
                            <div class="me-7 mb-4">
                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                  ...
                                  <img src="{{asset('public/AgentImage/'.$agentprofile->agent_image)}}" class="thumb-lg img-circle" alt="">
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="javascript:void(0);" class="text-gray-900 text-hover-primary fs-2x fw-bolder me-1">{{$agentprofile->company_name}}</a>
                                ...
                                <div class="d-flex flex-wrap flex-stack">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 pe-8">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <!--begin::Stat-->
                                            <div class="bg-white border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                <!--begin::Number-->
                                                <div class="d-flex align-items-center">

                                                    <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="1" data-kt-countup-prefix="">{{$countstudent}}</div>
                                                </div>
                                                <!--end::Number-->
                                                <!--begin::Label-->
                                            ...
                                            <div class="bg-white border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="0">{{$incomplete}}</div>
                                                </div>
                                                <!--end::Number-->
                                                <!--begin::Label-->
                                            ...
                                            <div class="bg-white border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="0" data-kt-countup-prefix="">{{$completeStudent}}</div>
                                                </div>
                                                <!--end::Number-->
                                                <!--begin::Label-->
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                            ...
                            <form method="POST" action="{{url('agent/profle-update')}}" accept-charset="UTF-8" id="kt_account_profile_details_form" class="form" enctype="multipart/form-data"><input name="_token" type="hidden" value="lI6eiEjV6IDjSV59mHL62H5ONp1uLGplpBdOWq19">
                            <!--begin::Card body-->
                            @csrf
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                  ...
                                  <img  data-toggle="modal" data-target="#exampleModalCenter" onclick="onClick(this)" src="{{asset('public/AgentImage/'.$agentprofile->agent_image)}}" width="100" height="100" class="thumb-lg img-circle" alt="" style="padding-bottom:10px; ">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="company_name" class="form-control form-control-lg form-control-solid" placeholder="Company Name" value="{{$agentprofile->company_name}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="agent_address" class="form-control form-control-lg form-control-solid" placeholder="Address" value="{{$agentprofile->agent_address}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Year of Established</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="established" class="form-control form-control-lg form-control-solid" placeholder="Year of Established" value="{{$agentprofile->established}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="first_name" class="form-control form-control-lg form-control-solid" placeholder="Owner Name" value="{{$agentprofile->first_name}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="email" name="email" class="form-control form-control-lg form-control-solid" placeholder="Email" value="{{$agentprofile->email}}">
                                   @if ($errors->has('email'))
                ...
                @endif
                 ...
                 <select name="country" id="country" class="form-control">
                    ...
                    <option value="{{$value->id}}" {{$agentprofile->country == $value->name  ? 'selected' : ''}}>{{$value->name}}</option>
                    @endforeach
                     </select>  
                ...
                @endif
                       ...
                       <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                    <input id="statessss" name="states" value="{{$agentprofile->state}}" class="form-control">
               <select id="state-dd" name="state" class="form-control">
                ...
                @endif                                </div>
                                 ...
                                 <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                    <input id="citiess" name="citys" value="{{$agentprofile->city}}" class="form-control">
 ...
 @if ($errors->has('city'))
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="phone" class="form-control form-control-lg form-control-solid" placeholder="Phone No" value="{{$agentprofile->phone}}">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="contact_person" class="form-control form-control-lg form-control-solid" placeholder="Contact Person" value="{{$agentprofile->contact_person}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="contact_email" class="form-control form-control-lg form-control-solid" placeholder="Contact Email" value="{{$agentprofile->contact_email}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="contact_phone" class="form-control form-control-lg form-control-solid" placeholder="Contact Phone" value="{{$agentprofile->contact_phone}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="bank_name" class="form-control form-control-lg form-control-solid" placeholder="Bank Name" value="{{$agentprofile->bank_name}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="bank_account" class="form-control form-control-lg form-control-solid" placeholder="Bank Account#" value="{{$agentprofile->bank_account}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="account_name" class="form-control form-control-lg form-control-solid" placeholder="Account Name" value="{{$agentprofile->account_name}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="bank_address" class="form-control form-control-lg form-control-solid" placeholder="Bank Address" value="{{$agentprofile->bank_address}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="routing" class="form-control form-control-lg form-control-solid" placeholder="Routing#" value="{{$agentprofile->routing}}">
                ...
                @endif
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="swift_code" class="form-control form-control-lg form-control-solid" placeholder="Swift Code" value="{{$agentprofile->swift_code}}">
                ...
                @endif
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <button type="reset" class="btn btn-light btn-active-light-primary me-2"><a href="{{url('agent/profile')}}">Discard</a></button>
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                                    <!--begin::Form-->
                                        ...
                                        <form method="POST" action="#" accept-charset="UTF-8" id="kt_signin_change_email" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate"><input name="_token" type="hidden" value="lI6eiEjV6IDjSV59mHL62H5ONp1uLGplpBdOWq19">
                                        <div class="row mb-6">
                                            <div class="col-lg-6 mb-4 mb-lg-0">
                                                <div class="fv-row mb-0">
                                                    <label for="emailaddress" class="form-label fs-6 fw-bolder mb-3">Enter New Email Address</label>
                                                    <input type="email" class="form-control form-control-lg form-control-solid" id="emailaddress" placeholder="Email Address" name="email" value="{{$agentprofile->email}}">
                                                </div>
                                            </div>
                            ...
                            <div class="d-flex flex-wrap align-items-center mb-10">
                                ...
                                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                                    <!--begin::Form-->
                                        ...
                                        <form method="POST" action="#" accept-charset="UTF-8" id="kt_signin_change_password" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate"><input name="_token" type="hidden" value="lI6eiEjV6IDjSV59mHL62H5ONp1uLGplpBdOWq19">
                                        <div class="row mb-1">
