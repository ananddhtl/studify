		...
		<div class="modal-content" id="taskbody">
			<div class="modal-header">
				...
				<button type="button" class="close" data-dismiss="modal">&times;</button> 
			      ...
			      <form method="POST" action="{{url('agent/add-task')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
                  @csrf            
                  <div class="w-100">
                                <!--begin::Heading-->
		...
		<div class="modal-content" id="taskbody">
			<div class="modal-header">
				...
				<button type="button" class="close" data-dismiss="modal">&times;</button> 
			      ...
			      <form method="POST" action="{{url('agent/update-task')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
                  @csrf            
                  <div class="w-100">
