...
<?php } ?>
                            ...
                            <div class="tab-pane fade show mb-5" role="tabpanel" aria-labelledby="pills-gallery-tab"
...
<a class="gallery-item" href="{{asset('public/InstitutionImage/'.$image->image)}}"
 ...
 <img class="rounded" src="{{asset('public/InstitutionImage/'.$image->image)}}"
                        ...
                        <div class="tab-pane fade show mb-5 courses-offered-content" role="tabpanel"
                             aria-labelledby="pills-courses-tab" id="scrollspyHeading5">
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                              ...
                              <li class="nav-item rand" role="presentation">
                                            <button class="nav-link active" id="bachelor-degree-tab"
                                                    data-bs-toggle="pill"
                                                    data-bs-target="#bachelor-degree" type="button" role="tab"
                                                    aria-controls="bachelor-degree" aria-selected="false">Bachelor's
                                                Degree
                                            </button>
                                        </li>
                                        @endif
                                    @if(count($master) != 0)  
                                     <li class="nav-item rand" role="presentation">
                                            <button class="nav-link" id="master-degree-tab" data-bs-toggle="pill"
                                                    data-bs-target="#master-degree" type="button" role="tab"
                                                    aria-controls="master-degree" aria-selected="true">Master's Degree
                                            </button>
                                        </li>
                                    @endif
                                     @if(count($diploma) != 0)                  
                                         <li class="nav-item rand" role="presentation">
                                            <button class="nav-link" id="diploma-tab" data-bs-toggle="pill"
                                                    data-bs-target="#diploma" type="button" role="tab"
                                                    aria-controls="master-degree" aria-selected="true">Diploma
                                            </button>
                                        </li>
                                        @endif
                                         ...
                                         @if(count($phd) != 0) 
                                         <li class="nav-item rand" role="presentation">
                                            <button class="nav-link" id="phd-tab" data-bs-toggle="pill"
                                                    data-bs-target="#phdss" type="button" role="tab"
                                                    aria-controls="master-degree" aria-selected="true">PHD
                                            </button>
                                        </li>
                                        @endif
                             ...
                             <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <?php    if($course){  ?>
                                            ...
                                            <div class="position-relative border-15 border-grey bg-white shadow-grey p-3 mb-5 pb-5">
                                                        ...
                                                        <div class="area-of-study mb-3">
                                                            <img src="{{asset('assets/images/study-student-icon.png')}}"
                                                                 alt="" class="me-3">
                                                       ...
                                                       @endphp
                                                        ...
                                                        <div class="intake">
                                                            <img src="{{asset('assets/images/intake-card.png')}}"
                                                                 alt="" class="me-3">
                                                            <span class="font-weight-700 me-3">Intake</span>
                                                            <ul class="intake-info d-inline-block ps-0">
                                                             <li class="d-inline-block me-3">
                                                        <img src="{{asset('assets/images/fall-leaf.png')}}"
                                                                             alt="">
                                                                </li>
                                                               <li class="d-inline-block me-3">
                                                                                                                                                                                                                <img src="{{asset('assets/images/summer-sun.png')}}"
                                                                             alt="">
                                                                                                                                                                                                            <span class="fall-text-title font-weight-700">Summer (May/June)</span>
                                                                    
                                                                </li>
                                                                     <li class="d-inline-block me-3">
                                                                                                                                                                                                                                                                                    <img src="{{asset('assets/images/spring-flower.png')}}"
                                                                             alt="">
                                                        ...
                                                        <div class="applied-btn position-absolute">
                                                            ...
                                                            $exit =  App\Models\universityCoursePayment::where('insitution_id', $id)->where('course_id', $courses->id)->where('student_id', $studentid)->where('payment_status', '1')->first();
                                                           @endphp
                                                            @if($exit)
                                                            <a href="#" class="btn btn-primary rounded-pill">Applied</a>
                                                            @else
                                                            <a href="{{url('/univeristy-apply/'.$id.'/'.$courses->id)}}" class="btn btn-primary rounded-pill">Apply Now</a>
                                                            @endif
                                                            @else
                                                            <a href="#" class="btn btn-primary rounded-pill"  data-bs-toggle="modal"  data-bs-target="#staticBackdrop_72446">Apply Now</a>
                                                            ...
                                                            <div class="modal fade" id="staticBackdrop_72446"
                               ...
                               No course found
                                            ...
                                            <div id="load_more_bachelor_block">
                                                <input type="hidden" name="loadmoreBachelorPagination"
                                                       id="loadmoreBachelorPagination" value="10">
                                    ...
                                    <div class="tab-pane fade" id="master-degree" role="tabpanel"
                                         aria-labelledby="master-degree-tab">
                             ...
                             <div class="position-relative border-15 border-grey bg-white shadow-grey p-3 mb-5 pb-5">
                                                       ...
                                                       <div class="area-of-study mb-3">
                                                        ...
                                                        <div class="intake">
                                                            <img src="{{asset('assets/images/intake-card.png')}}"
                                                                 ...
                                                                 <span
                                                                    class="font-weight-700 me-3">Intake</span>
                                                            ...
                                                            @php
                                                            $studentid = Session::get('student_id');
                                                            $exit =  App\Models\universityCoursePayment::where('insitution_id', $id)->where('course_id', $coursess->id)->where('student_id', $studentid)->where('payment_status', '1')->first();
                                                           @endphp
                                                            @if($exit)
                                                            <a href="#" class="btn btn-primary rounded-pill">Applied</a>
                                                            @else
                                                            <a href="{{url('/univeristy-apply/'.$id.'/'.$coursess->id)}}" class="btn btn-primary rounded-pill">Apply Now</a>
                                                            @endif
                                                            @else
                                                            <a href="#" class="btn btn-primary rounded-pill"  data-bs-toggle="modal"  data-bs-target="#staticBackdrop_72446">Apply Now</a>
                                                            ...
                                                            <div class="modal fade" id="staticBackdrop_72478"
                                                                 data-bs-backdrop="static" data-bs-keyboard="false"
                                                                 aria-labelledby="staticBackdropLabel"
                                                                 aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div id="loader" style="display: none;"><img src="images/loading.gif"
                                                                                         alt="Loading..."></div>
                                            <div id="load_more_master_block">
                                                <input type="hidden" name="loadmoreMasterPagination"
                                                       id="loadmoreMasterPagination" value="10">
                             ...
                             <div class="position-relative border-15 border-grey bg-white shadow-grey p-3 mb-5 pb-5">
                                                       ...
                                                       <div class="area-of-study mb-3">
                                                        ...
                                                        <div class="intake">
                                                            ...
                                                            @php
                                                            $studentid = Session::get('student_id');
                                                            $exit =  App\Models\universityCoursePayment::where('insitution_id', $id)->where('course_id', $diplomas->id)->where('student_id', $studentid)->where('payment_status', '1')->first();
                                                           @endphp
                                                            @if($exit)
                                                            <a href="#" class="btn btn-primary rounded-pill">Applied</a>
                                                            @else
                                                            <a href="{{url('/univeristy-apply/'.$id.'/'.$diplomas->id)}}" class="btn btn-primary rounded-pill">Apply Now</a>
                                                            @endif
                                                            @else
                                                            <a href="#" class="btn btn-primary rounded-pill"  data-bs-toggle="modal"  data-bs-target="#staticBackdrop_72446">Apply Now</a>
...
<!-- phd  -->
                                      <div class="tab-pane fade" id="phdss" role="tabpanel"
                                         aria-labelledby="master-degree-tab">
                                        <div id="master-degree-block">
                                <?php    if($phd){  ?>
                                            @foreach($phd as $phds)
                ...
                <div class="tab-pane fade" id="certificates" role="tabpanel"
                                            ...
                                            <div id="load_more_master_block">
                                                ...
                                                <a href="javascript:void(0)" onclick="javascript:loadmoreMaster();"
                                                   class="btn btn-primary rounded-pill">Load more master</a>
                                                                                                                                      ...
                                                                                                                                      <div class="tab-pane fade" id="pathway-degree" role="tabpanel"
                                         aria-labelledby="pathway-degree-tab">
                                        <div id="pathway-degree-block">
                                                                                                                                </div>
                                                                            </div>
                                    <div class="tab-pane fade" id="associate-degree" role="tabpanel"
                                         aria-labelledby="associate-degree-tab">
                        ...
                        <div class="tab-pane fade show mb-5 fee-section" role="tabpanel"
                             aria-labelledby="pills-tution-tab" id="scrollspyHeading6">
                            ...
                            <div class="row">
                                            ...
                                            <div class="border-15 border-grey bg-white shadow-grey p-3 mb-5">
                                                <h4 class="tf-heading color-green">{{$feesbachelors->c_name}}</h4>
                                                  <dl class="row">
                                                    ...
                                                    <dd class="border-bottom col-sm-4 col-4  font-weight-700">${{$feesbachelors->tution_fees}}</dd>
                                        <?php } else { ?><dd class="border-bottom col-sm-4 col-4  font-weight-700">--</dd>
                                         <?php } ?> 
                                                    ...
                                                    <?php if($feesbachelors != '') { ?>
                                                    <dd class="border-bottom col-sm-4 col-4  font-weight-700">${{$feesbachelors->acc_other_fees}}</dd>
                                                <?php } else { ?> 
                                            ...
                                            <?php } ?>
                                                     ...
                                                     <?php if($feesbachelors != '') { ?> 
                                                    <dd class="border-bottom col-sm-4 col-4  font-weight-700">${{$feesbachelors->application_fees}}</dd>
                                                    <?php } else { ?> 
                                                   <dd class="border-bottom col-sm-4 col-4  font-weight-700">- -</dd>
                                                    <?php } ?>
                                        ...
                                        <dt class="col-sm-8 col-8  font-weight-700 mt-1">Total</dt>
                                                    <?php if($feesbachelors != '') { ?>
                                                <dd class=" col-sm-4 col-4  font-weight-700 mt-1">$<?php $z = $feesbachelors->tution_fees + $feesbachelors->acc_other_fees + $feesbachelors->application_fees; echo $z; ?></dd>
                                            <?php } else { ?> 
                        ...
                        <div class="tab-pane fade show mb-5 fee-section" role="tabpanel"
                             aria-labelledby="pills-requirement-tab" id="scrollspyHeading7">
                                            ...
                                            <div class="border-15 border-grey bg-white shadow-grey p-3 mb-5">
                                                ...
                                                <dl class="row">
                                                    ...
                                                    <dt class="border-bottom col-sm-8 col-8  font-weight-700">Minimum GPA
                                                     ...
                                                     <dd class="border-bottom col-sm-4 col-4  font-weight-700">{{$reqbachelors->min_gpa}}</dd>
                                                    ...
                                                    <dd class="border-bottom col-sm-4 col-4  font-weight-700">{{$reqbachelors->education}}</dd>
                                                        ...
                                                        <dd class="border-bottom col-sm-4 col-4  font-weight-700">{{$reqbachelors->Pearson}}</dd>
                                                         
                                                         <dt class="border-bottom col-sm-8 col-8  font-weight-700">Minimum Duolingo
                                                        </dt>
                                                         
                                                        <dd class="border-bottom col-sm-4 col-4  font-weight-700">{{$reqbachelors->Duolingo}}</dd>
                                                        <?php } else { ?>
                ...
                <aside class="col-lg-4 inst-sidebar  border-15 p-3">
                    ...
                    <div class="inst-map">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3019.4883962920376!2d-73.59226248459187!3d40.81723487932056!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c28670227f87b1%3A0xc66e8187e8128a37!2sLIU%20Post!5e0!3m2!1sen!2sus!4v1643402755531!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                ...
                <div class="row row-cols-sm-2 row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                    @foreach($allinstitution as $allinstitutions)
                            ...
                            <div class="card border-7 inst-card h-100">
                             ...
                             <img src="{{asset('public/InstitutionImage/'.$allinstitutions->univ_img)}}" alt="Hult International Business School- New York"
                                ...
                                <span class="d-block uni-location "><i class="ri-map-pin-fill color-red "></i>
                                    ...
                                    <ul class="list-group ">
                                        <li class="list-group-item d-flex justify-content-between align-items-center ">
                                            University Type
                                            <span class="badge bg-primary rounded-pill ">{{$allinstitutions->univ_type}}</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center ">
                                            Founded
                                            <span class="badge bg-primary rounded-pill ">{{$allinstitutions->founded}}</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center ">
                                            International Students
                                            <span class="badge bg-primary rounded-pill ">{{$allinstitutions->international_student}}+</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center ">
                                            Type
                                            <span class="badge bg-primary rounded-pill ">{{$allinstitutions->type}}</span>
                                        </li>
                                    </ul>
                                    </p>
                                    <a class="ab-button" href="{{url('universitiesdetails/'.$allinstitutions->id)}}" role="button"><i
    ...
    <section class="container py-lg-5 pt-5 pb-sm-5 pb-4 px-0">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-12 home-subscription-block my-auto">
                    <form method="POST" action="#" accept-charset="UTF-8" class="subscribe-block needs-validation position-relative" novalidate><input name="_token" type="hidden" value="jG9NMTI1P7LJhFsVFIjpakGuLbtIQABLVidSG05G">
