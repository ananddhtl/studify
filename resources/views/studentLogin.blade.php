...
<div class="d-lg-flex half ap-form">
    ...
    <div class="contents order-1 order-md-2 position-relative">
        <a href="{{url('agent/login')}}" class="btn btn-outline-success btn-hover-shadow rounded-pill position-fixed login-right-button">Login as Counselor</a>

        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
              
                    <h3 class="mb-4">Student <span class="font-weight-400"> Login</span></h3>
                   @if(Session::has('approve'))
                    ...
                    @if(Session::has('fail'))
                        ...
                        @endif
                    <form action="{{ route('studentlogincheck') }}" method="POST">
                    @csrf         
                        ...
                        <div class="d-flex mb-5 align-items-center space-between">
                          <span class="text-end"><a href="{{url('/member/forgotpassword')}}" class="forgot-pass text-end">Forgot Password</a></span>
                        </div>

                        <button type="submit" value="" class="btn btn-primary rounded-pill submit px-5">Sign In to Student Dashboard</button>
   ...
   <!--  <li><a href="#"><img src="{{asset('assets/images/facebook-login-button.png')}}" alt="Facebook Login" title="Facebook Login" style="max-width: 180px;"></a></li>
    <li><a href="#"><img src="{{asset('assets/images/gmail-login-button.png')}}" alt="Google Login" title="Google Login" style="max-width: 210px;"></a></li> -->
                    ...
                    <div class="seperate mt-3"><span> + </span></div>
                    <p class="already mt-3 mb-0">Don't have an account? <a href="{{url('/member/register')}}">Register Now</a></p>
