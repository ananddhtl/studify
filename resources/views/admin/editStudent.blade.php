                ...
                <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="application_manager_stepper">
                    ...
                    <div class="card d-flex flex-row-fluid flex-center">
                        ...
                        <div  data-kt-stepper-element="content" id="personal_info">
                         @endif
                            <!--begin::Wrapper-->
                            <form method="POST" action="{{url('admin/student/update')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                          @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="first_name" id="first_name" class="form-control form-control-lg form-control-solid" value="{{$student->first_name}}" />
                                       @error('first_name')
                                ...
                                @enderror
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="last_name" id="last_name" class="form-control form-control-lg form-control-solid" value="{{$student->last_name}}" />
                                        @error('last_name')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                        <!--end::Input-->
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="email" name="email" id="email" class="form-control form-control-lg form-control-solid" value="{{$student->email}}" />
                                    @error('email')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                    <!--end::Input-->
                                ...
                                <div class="col-6">
                                    ...
                                    <!--end::Label-->
                                            ...
                                            <input type="text" name="phone" id="phone" class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="{{$student->phone}}" />
                                      @error('phone')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--begin::Input-->
                                        <?php if($student->dob !='') {  ?> 
                 <input type="date" id="ab_datepicker_dob" name="dob" placeholder="Select a date" class="form-control mb-2" value="{{$student->dob}}" />
   ...
   @error('dob')
                                ...
                                @enderror
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="birth_place_country" name="country" placeholder="Enter the Birth Place Country" class="form-control mb-2" value="{{$student->country}}" />
                                         <?php } else { ?>
         ...
         height="80">
                    @error('student_img')
                            ...
                            <div class="d-flex flex-stack pt-10">
                                ...
                                <!--begin::Wrapper-->
                                <div>
                                    <button type="submit" class="btn btn-lg btn-primary address">Continue</button>
                                </div>
                                <!--end::Wrapper-->
                            </div>
                            </form>
                        ...
                        <div id="address_info" class="current" data-kt-stepper-element="content">
                            ...
                            <!--begin::Wrapper-->
                            @if($address)
                             <form method="POST" action="{{url('admin/student/updateAddress')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                            @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
             <input name="id" type="hidden" id="street_name" class="" value="{{$student->id}}" />
                            ...
                            <div class="d-flex flex-stack pt-10">
                                <!--begin::Wrapper-->
                                <div class="mr-2">
                                    <a href="#" class="btn btn-lg btn-light-primary me-3 personal">Back</a>
                            ...
                            @else
                            <form method="POST" action="{{url('admin/student/addAddress')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                            @csrf
                            <input type="hidden" name="tab" value="address">
                            <div class="w-100">
                                <!--begin::Heading-->
             ...
             <input name="id" type="hidden" id="street_name" class="" value="{{$student->id}}" />
                        ...
                        <div id="language_info" class="current" data-kt-stepper-element="content">
                         ...
                         <div id="language_info" data-kt-stepper-element="content">
                            ...
                            <!--begin::Wrapper-->
                           @if($language)
                       <form method="POST" action="{{url('admin/student/updateLanguageScore')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                           @csrf
                            <input type="hidden" value="{{$language->student_id}}" name="id" value="language_score">
                            <div class="w-100">
                                <!--begin::Heading-->
                                <div class="pb-10 pb-lg-12">
                                    <!--begin::Title-->
                        ...
                        @endif
                            <!--begin::Wrapper-->
                            <!--begin::Wrapper-->
                            <form method="POST" action="{{url('admin/student/updateGpaScore')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                           @csrf
                            ...
                            <div class="w-100">
                                ...
                                <div class=" fv-row mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input name="gpa_score" id="gpa_total" class="form-control form-control-lg form-control-solid" value="{{$student->gpa_score}}" />
                                    @error('gpa_score')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                    <!--end::Input-->
                        ...
                        @endif
                            ...
                            <form method="POST" action="{{url('admin/student/updateacademic')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                            @csrf
                        ...
                        <div id="emergency_info" class="current" data-kt-stepper-element="content">
                         ...
                         <div id="emergency_info"  data-kt-stepper-element="content">
                            ...
                            <!--begin::Wrapper-->
                            @if($contact)
 <form method="POST" action="{{url('admin/student/updateContact')}}" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                             @csrf
                       ...
                       <div id="documents_info" data-kt-stepper-element="content">
                            ...
                            <!--begin::Wrapper-->
                            <!--begin::Wrapper-->
                            <form method="POST" action="{{url('admin/student/upload-documents')}}"  class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework form-image-passporter" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
                            @csrf
                     ...
                     <input type="file" id="images" name="passport[]" multiple >
                            ...
                            <a href="{{url('admin/student/delete-passport/'.$passportimages->id)}}" id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                            @endif
...
<label for="images" class="drop-container">
                            ...
                            <a href="{{url('admin/student/delete-marksheet/'.$marksheets->id)}}" id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                            @endif
                            ...
                            <a href="{{url('admin/student/delete-recommendations/'.$recommendations->id)}}" id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                            @endif
                            ...
                            <a href="{{url('admin/student/delete-financials/'.$financials->id)}}" id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                            @endif
                            ...
                            <a href="{{url('admin/student/delete-other/'.$others->id)}}" id="cross"><i class="fa fa-times" aria-hidden="true"></i></a>
                            @endforeach
                            @endif
