...
<div class="container">
                ...
                <div class="use">
                    <div class="list">
                        ...
                        <img src="{{asset('/public/AgentImage/'.$data->agent_image )}}" alt="Logo"
                            style="width: 100px;">
                        @else
                        <img src="{{asset('/public/AgentImage/no-image.png')}}" alt="Logo" style="width: 100px;">
    ...
    <div class="col-sm-6" id="sms1">
        ...
        <form id="First" method="POST" action="{{url('admin/email')}}" accept-charset="UTF-8"
            ...
            <div class="row fv-row mb-10">
                <div class="col-12">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <select class="form-select form-control form-control-lg form-control-solid" name="email" id="member"
            ...
            <div class="row fv-row mb-10">
                <div class="col-12">
                    ...
                    <input type="text" name="subject" id="subject"
                        class="form-control form-control-lg form-control-solid" placeholder="Enter Subject" value="">
                    <!--end::Input-->
                </div>
        ...
        <form id="Second" method="POST" action="{{url('admin/send-email-group')}}" accept-charset="UTF-8"
            class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
            id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="row fv-row mb-10">
                <div class="col-12">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <select class="form-select form-control form-control-lg form-control-solid chosen-select"
                        name="group" aria-label="Default select example" multiple="">
