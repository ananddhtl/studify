                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                         ...
                         <select class="form-select" name="topic_id" aria-label="Default select example" readonly>
                       ...
                       <div class="form-group">
                           ...
                           <br>
                            <img src="{{asset('/public/ChapterImage/'.$chapter->image)}}" alt="Girl in a jacket" style="width: 100px;height: 70px;">
                        </div><br>
                 ...
                 <div class="form-group">
                         <label class="form-label required">Chapter Name</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="chapter_name" id="last_name" class="form-control form-control-lg form-control-solid" value="{{$chapter->chapter_name}}" readonly>
                       ...
                       <div class="form-group">
                         <label class="form-label required">Chapter Sub Title</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="chapter_subtitle" id="last_name" class="form-control form-control-lg form-control-solid" value="{{$chapter->chapter_subtitle}}" readonly>
