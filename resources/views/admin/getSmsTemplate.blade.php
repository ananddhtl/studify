...
@endif
  ...
  <i class="fa fa-plus" aria-hidden="true" id="icn"></i>Add SMS Template
</a>
                            </div>
                            <div class="card-body">
                                ...
                                <td>{{$i++}}</td>
                                  ...
                                  <td> <a class="" href="{{url('/admin/edit-template/'.$addSmsTemplates->id)}}"><i class="fa fa-pencil" aria-hidden="true" id="icn"></i></a>   
                             <a class=""  onclick="return confirm('Are you sure you want to delete this ?');" href="{{url('/admin/delete-template/'.$addSmsTemplates->id)}}"><i  style="color:red" class="fa fa-trash" aria-hidden="true" id="icn"></i></a>   </td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content" id="width">
        ...
        <form method="POST" action="{{url('/admin/add-sms-template')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
            @csrf
