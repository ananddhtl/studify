            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Institutions Report List</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active"> Institutions Report List</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                              <div class="card-header">
                                <strong class="card-title"></strong>
                                 <a style="float: right;" href="{{url('/admin/insitution-report/generate-pdf')}}" class="add"><i class="fa fa-plus" aria-hidden="true" id="icn"></i>Export to PDF</a>
                            </div>
                            <div class="card-body">
...
<table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th id="main">Sr No.</th>
                                            <th id="main"> Institution Name</th>
                                            <th id="main">Name</th>
                                            <th id="main">Email</th>
                                            <th>Image</th>
                                            <th>Created</th>
