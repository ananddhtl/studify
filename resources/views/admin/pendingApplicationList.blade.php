                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Pending Applications List</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <!-- <a class="" href="{{url('admin/student-edit/'.$user->id)}}"><i class="fa fa-pencil" aria-hidden="true" id="icn"></i></a> -->
                                    <a class="" title="View Application"  href="{{url('admin/student-detail/'.$user->id)}}"><i class="fa fa-eye" aria-hidden="true" id="eye"></i></a>
                                    <a title="Resolve Application"   href="{{url('/admin/recheck-application/'.$user->id)}}" ><i class="fa fa-undo" aria-hidden="true" id="undo"></i></a>

                                    <a title="Send to insitution"  href="{{url('admin/send-to-insitution/'.$user->id)}}" ><i class="fa fa-send-o" aria-hidden="true" id="icn"></i></a>
              </td>
                                      </tr>
                                        @endforeach 
                                    </tbody>
