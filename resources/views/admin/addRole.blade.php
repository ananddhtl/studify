...
<div class="container">
    <div class="row">
        <div class="box">
            <div class="col-sm-6" id="sms">
                ...
                @if ($editRole != '')
                    <form method="POST" action="{{ url('admin/update-role-features') }}" accept-charset="UTF-8"
                        ...
                        <div class="w-100">
                            ...
                            <div class="row fv-row mb-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input name="name" id="first_name"
                                        class="form-control form-control-lg form-control-solid"
                                        value="{{ $editRole->name }}" placeholder="Name">
                                    <!--end::Input-->
                                </div>
                                <div class="col-6">
                                    <!--begin::Label-->
                                    ...
                                    <input type="text" name="phone" id="phone"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="Phone number" value="{{ $editRole->phone }}">
                                    <!--end::Input-->
                                </div>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row fv-row mb-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="email" name="email" id="email"
                                        class="form-control form-control-lg form-control-solid"
                                        value="{{ $editRole->email }}" placeholder="Email">
                                </div>
                                    ...
                                    <select name="country" class="form-select" aria-label="Default select example">
                                        ...
                                        @foreach ($country as $countries)
                                            <option value="{{ $countries->country_name }}"
                                                {{ $countries->country_name == $editRole->country ? 'selected' : '' }}>
            ...
            <div class="col-sm-6" id="sms1">
                <h2 class="fw-bolder text-dark">Roles & Permissions</h2>
                <br>
                <div class="fv-row mb-10" id="mang">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        @if (array_search('managestudent', $strreplace) != '')
                            <label class="chek">Manage Student
                                <input type="checkbox" name="rolefeatures[]" value="managestudent" checked>
                                <span class="checkmark"></span>
                            </label>
                        @else
                            <label class="chek">Manage Student
                                <input type="checkbox" name="rolefeatures[]" value="managestudent">
                                <span class="checkmark"></span>
                            </label>
                        @endif

                        @if (array_search('manageagent', $strreplace) != '')
                            <label class="chek">Manage Agent
                                <input name="rolefeatures[]" value="manageagent" type="checkbox" checked>
                                <span class="checkmark"></span>
                            </label>
                        @else
                            <label class="chek">Manage Agent
                                <input name="rolefeatures[]" value="manageagent" type="checkbox">
                                <span class="checkmark"></span>
                            </label>
                        @endif

                        @if (array_search('manageinsitution', $strreplace) != '')
                            <label class="chek">Manage Institution
                                <input name="rolefeatures[]" value="manageinsitution" type="checkbox" checked>
                                <span class="checkmark"></span>
                            </label>
                        @else
                            <label class="chek">Manage Institution
                                <input name="rolefeatures[]" value="manageinsitution" type="checkbox">
                                <span class="checkmark"></span>
                            </label>
                        @endif
                        @if (array_search('manageblog', $strreplace) != '')
                            <label class="chek">Manage Blogs
                                <input name="rolefeatures[]" value="manageblog" type="checkbox" checked>
                                <span class="checkmark"></span>
                            </label>
                        @else
                            <label class="chek">Manage Blogs
                                <input name="rolefeatures[]" value="manageblog" type="checkbox">
                                <span class="checkmark"></span>
                            </label>
                        @endif

                        @if (array_search('managefaq', $strreplace) != '')
                            <label class="chek">Manage FAQ
                                <input name="rolefeatures[]" value="managefaq" type="checkbox" checked>
                                <span class="checkmark"></span>
                            </label>
                        @else
                            <label class="chek">Manage FAQ
                                <input name="rolefeatures[]" value="managefaq" type="checkbox">
                                <span class="checkmark"></span>
                            </label>
                        @endif
                        ...
                        @if (array_search('managerole', $strreplace) != '')
                            <label class="chek">Roles & Permissions
                                <input name="rolefeatures[]" value="managerole" type="checkbox" checked>
                                <span class="checkmark"></span>
                            </label>
                        @else
                            <label class="chek">Roles & Permissions
                                <input name="rolefeatures[]" value="managerole" type="checkbox">
                                <span class="checkmark"></span>
                            </label>
                        @endif
    ...
    @else
        <form method="POST" action="{{ url('admin/add-role-features') }}" accept-charset="UTF-8"
            class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework"
            id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
            @csrf
            <div class="w-100">
                ...
                <div class="row fv-row mb-10">
                    ...
                    <div class="col-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input name="name" id="first_name" class="form-control form-control-lg form-control-solid"
                ...
                <div class="row fv-row mb-10">
                    ...
                    <div class="col-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input name="role" id="first_name" class="form-control form-control-lg form-control-solid"
                            value="e.g.:Manage">
                        <!--end::Input-->
                    </div>
