...
<div class="col-sm-6" id="sms">
 ...
 @if($editRole !='')
 <form method="POST" action="{{url('admin/update-role-features')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
    @csrf
...
@else
<form method="POST" action="{{url('admin/add-role-features')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
    @csrf
                               <div class="w-100">
                                <!--begin::Heading-->
