        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active">Add Student FAQ</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Add Student FAQ</strong>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{url('admin/add-faq')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="type" id="question"
                                    class="form-control form-control-lg form-control-solid" value="student">
                            </div>
