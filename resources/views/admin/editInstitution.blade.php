                        ...
                        <div class="card-body px-6 px-lg-10 px-xxl-15 py-20">
                            ...
                            <div class="stepper-nav">
                                ...
                                <div class="stepper-item current" id="personal_info" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                    @else
                                <div class="stepper-item" id="personal_info" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                    @endif
                                    <!--begin::Line-->
                                ...
                                <div class="stepper-item current" id="about_info" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                    @else
                                ...
                                <div class="stepper-item current" id="glance_info" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                    @else
                                ...
                                <div class="stepper-item current" id="video_info" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                    @else
                                ...
                                <div class="stepper-item current" id="gallery_info" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                                    @else
...
<td><button type="button" name="add"  class="btn btn-danger"><a href="{{url('admin/glance/delete/'.$glances->id)}}" style="color:#fff;">Delete</a></button></td>  
</tr> 
@endforeach 
</table> 
...
<tr>  
<td><input type="text" name="moreFields[0]" placeholder="Enter glance" value="" class="form-control" /></td>  
...
<button type="submit" class="submit">Next</button>
                        ...
                        <!--begin::Step 5-->
                         @if(request()->session()->get('status') == 'gallery')
                        <div class="current" id="gallery" data-kt-stepper-element="content">
                            @else
                         <div class="" id="gallery"   data-kt-stepper-element="content">
                            @endif
                            <!--begin::Wrapper-->
                            <form method="POST" action="{{url('admin/institution/uploadmultipleimage')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="tPmnvV6qvFnZ5PIT401Rz9XwTSBsb8ute5hA7yqp">
                                @csrf
...
@endforeach
  ...
  <form action="/action_page.php">
    <br><br>
  <input type="file" id="myFile" name="multipleimages[]" multiple><br><br>
  <button type="submit" class="submit">Submit</button>
                            ...
                            <div class="w-100">
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="e_contact_name" id="e_contact_name" class="form-control form-control-lg form-control-solid" value="" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="e_relationship" id="e_relationship" class="form-control form-control-lg form-control-solid" value="" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row fv-row mb-10">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="e_contact_phone" id="e_contact_phone" class="form-control form-control-lg form-control-solid" value="" />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-6">
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input name="e_contact_email" id="e_contact_email" class="form-control form-control-lg form-control-solid" value="" />
                                        <!--end::Input-->
                                    </div>
                                </div>
                                <!--end::Input group-->
                        ...
                        <div class="" data-kt-stepper-element="content">
                            <!--begin::Wrapper-->
                            <!--begin::Wrapper-->
                            <form method="POST" action="#" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework form-image-passporter" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="tPmnvV6qvFnZ5PIT401Rz9XwTSBsb8ute5hA7yqp">
                                    ...
                                    <div class="form-group row rounded border p-10">
                                        <div class="col-lg-12">
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <!--begin::Info-->
                                                        <div class="ms-4">
                                                            <h3 class="fs-5 fw-bolder text-gray-900 mb-1">Drop files here or click to upload your passport image</h3>
                                                            <span class="fs-7 fw-bold text-gray-400">Upload image file</span>
                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                </div>
                            ...
                            <div class="d-flex flex-stack pt-10">
                                ...
                                <!--begin::Wrapper-->
                                <div>
                                    <button type="button" id="docUpload" class="btn btn-lg btn-primary">Continue</button>
                                </div>
                                <!--end::Wrapper-->
                            </div>
                            </form>
