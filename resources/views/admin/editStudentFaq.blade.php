                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Edit Student FAQ</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Edit Student FAQ</strong>
                            </div>
                            <div class="card-body">
                        <form method="post" action="{{url('admin/update-student-faq/'.$faq->id)}}" enctype="multipart/form-data">
                        @csrf
  <div class="form-group">
                         <label class="form-label required">Question</label>
                                        ...
                                        <input name="question" id="question" class="form-control form-control-lg form-control-solid" value="{{$faq->question}}">
                                         <input type="hidden" name="type" id="question" class="form-control form-control-lg form-control-solid" value="student">
 </div>
