...
<form id="First" method="POST" action="{{url('admin/send-smss')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
@csrf
              ...
              <div class="row fv-row mb-10">
                     ...
                     <div class="row fv-row mb-10">
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="phone" id="phone" class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="Studify" readonly>
                                                                                <!--end::Input-->
                                    </div>
                                 <div class="col-6">
...
<form id="Second" method="POST" action="{{url('admin/send-group-smss')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="1AQUWWOQc2CvYMkwUfJPFLsEQiMaWaFKtyrMdcmb">
          @csrf
                    ...
                    <div class="w-100">
                        ...
                        <div class="row fv-row mb-10">
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="phone" id="phone" class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="studify">
                                                                                <!--end::Input-->
                                    </div>
                                 <div class="col-6">
                                    <label class="d-flex align-items-center form-label">
