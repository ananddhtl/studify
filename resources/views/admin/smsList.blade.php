        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $i = '1';
                                        @endphp
                                        @foreach($smspackage as $smspackages)
                                      <tr>
                                        <td>{{$i++}} </td>
                                        <td>{{$smspackages->package_name}}</td>
                                        <td>{{$smspackages->package_price}}</td>
                                        <td>{{$smspackages->sms_limit}}</td>
                                        <td>{{$smspackages->country}}</td>
                                      <td>
                    ...
                    <a  id="{{$smspackages->id}}" class="editicon" data-toggle="modal" data-target="#Mymodal1"><i class="fa fa-pencil" aria-hidden="true" id="icn"></i></a>
                    <a href="{{url('/admin/sms-package-delete/'.$smspackages->id)}}" class=""><i class="fa fa-trash" aria-hidden="true" id="del"></i></a>
                </td>
                                      </tr>
                                      @endforeach
                                      @else
 ...
 <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content" id="width">
        ...
        <form method="POST" action="{{url('/admin/add-sms-package')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
        @csrf                      
        <div class="w-100">
                                <!--begin::Heading-->
                                ...
                                <div class="col-6">
                                    <!--begin::Label-->
                                    <label class="form-label required">Sms Limit</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input name="sms_limit" id="first_name" class="form-control form-control-lg form-control-solid" value="" placeholder="Sms Limit">
                                                                            <!--end::Input-->
                                </div>
 ...
 <div class="modal fade" id="Mymodal1" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content" id="width">
        ...
        <form method="POST" action="{{url('/admin/update-sms-package')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
        @csrf                      
        <div class="w-100">
                                <!--begin::Heading-->
                                ...
                                <div class="col-6">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input name="sms_limit" id="sms_limit" class="form-control form-control-lg form-control-solid" value="" placeholder="Sms Limit">
                                                                            <!--end::Input-->
                                </div>
...
$(document).on('click', '.editicon', function(e) {
        ...
        $.ajax({
          url: '{{ url('/admin/edit-sms-package') }}',
          method: 'get',
          data: {
             id: id,
            _token: '{{ csrf_token() }}'
          ...
          success: function(response) {
           ...
           $("#sms_limit").val(response.sms_limit);
