...
@endif
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                      ...
                                      <?php $i = 1; ?>
                                      @foreach($smsgroup as $groups)
                                       <tr>
                                       <td>{{$i++}}</td>
                                       <td>{{$groups->group_name}}</td>
                                       <td>{{$groups->group_description}}</td>
                                       <td>{{$groups->type}}</td>
                                       <td><a href="{{url('/admin/add-sms-group-members/'.$groups->id)}}" title="Add Members"><i style="color:green;" class="fa fa-users" aria-hidden="true"></i></a>
                                       ...
                                       <a href="{{url('/admin/delete-sms-group/'.$groups->id)}}" title="Add Members"><i style="color:red;" class="fa fa-trash" aria-hidden="true"></i></a>
                                    </td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content" id="width8" >
        ...
        <form method="POST" action="{{url('/admin/add-sms-group')}}" accept-charset="UTF-8" class="card-body2 x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
            @csrf
                               <div class="w-100">
                                <!--begin::Heading-->
...
<br>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content" id="width8" >
        ...
        <form method="POST" action="{{url('/admin/update-sms-group')}}" accept-charset="UTF-8" class="card-body2 x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
            @csrf
                               <div class="w-100">
                                <!--begin::Heading-->
