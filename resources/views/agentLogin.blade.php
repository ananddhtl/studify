...
<html lang="en">
<head>
  <title> Login as Counselor page</title>
   <meta charset="utf-8">
...
<div class="d-lg-flex half ap-form">
    ...
    <div class="contents order-1 order-md-2 position-relative">
        <a href="{{url('/member/login')}}" class="btn btn-outline-danger btn-hover-shadow rounded-pill position-fixed login-right-button">Login as Student</a>

        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
                    <h3 class="mb-4">Counselor <span class="font-weight-400"> Login</span></h3>
                    @if(Session::has('fail'))
                        <p class="alert alert-info">{{ Session('fail') }}</p>
                        @endif
                        <form action="{{url('/agentlogincheck')}}" method="POST">
                    @csrf                                            
                    ...
                    <div class="d-flex mb-5 align-items-center space-between">
                            ...
                            <span class="text-end"><a href="{{url('/agent/forgotpassword')}}" class="forgot-pass text-end">Forgot Password</a></span>
                        </div>

                        <button type="submit" value="" class="btn btn-primary rounded-pill submit px-5">Sign In to Counselor Dashboard</button>
                    ...
                    <p class="already mt-3 mb-0">Don't have an account? <a href="{{url('/agent/register')}}">Register Now</a></p>
