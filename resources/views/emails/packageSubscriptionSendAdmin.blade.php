...
<div class="container">
<div class="row">
<h3> Subscription Package For {{$details['type']}} </h3>
...
<br>
<b>{{$details['agent_name']}} have subscribed to the ({{$details['package_name']}}) at AUD{{$details['package_price']}}/month or annual.</b><br><br>
<br><br>
