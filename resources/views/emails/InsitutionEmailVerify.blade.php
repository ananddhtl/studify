...
To complete the verification process, please click on the following link: <a href="{{url('/institution/email-verify/'.$details['id'])}}">Verify</a>. If the link does not work, copy and paste it into your web browser.<br>
 <br>
