...
<html lang="en">
<head>
  <title>Institution Login Forget-password page</title>
   <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7" id="forget">
                    ...
                    <form method="POST" action="{{url('/insitution/forgot_email_check')}}" accept-charset="UTF-8" class="log__form" id="forgotpassword"><input name="_token" type="hidden" value="lAUnX8Kii7fhBeMvpLW4aFg16uAyf92CgbNEQQEs">
                    @csrf                           
