...
<img src="{{asset('public/AgentImage/'.$agents->agent_image)}}" class="card-img-top">
@else
<img src="{{asset('public/AgentImage/noImage.webp')}}" class="card-img-top">
@endif
                                                         </a>
                            </div>
                          ...
                          {{$agents->first_name}} {{$agents->last_name}}
                                ...
                                <ul class="list-group ">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center ">
                                        Address
                                        <span class="badge bg-primary rounded-pill ">{{$agents->agent_address}}</span>
                                    </li>
