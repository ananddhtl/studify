                                ...
                                @enderror
                                    ...
                                    <div class="col-6">
                                        ...
                                        <?php if($student->country !='') { ?> 
                                            <select id="birth_place_country" name="country" class="form-select" aria-label="Default select example">
                                            <option selected>Select your birth place</option>
                                            @foreach($country as $countrys)
                                            <option value="{{$countrys->name}}" {{$student->country == $countrys->name  ? 'selected' : ''}}>{{$countrys->name}}</option>
                                           @endforeach
                                            </select>   
         ...
         height="80">
             ...
             <select name="countries_id" id="countries_id" aria-label="Select a Country" data-control="select2" data-placeholder="Select a country..." class="form-select form-select-solid form-select-lg fw-bold">
                            ...
                            <div class="d-flex flex-stack pt-10">
                                ...
                                <!--begin::Wrapper-->
                                <div>
                                    <button type="submit" class="btn btn-lg btn-primary language">Continue</button>
                                </div>
                                <!--end::Wrapper-->
                            </div>
                            </form>
                            ...
                            <div class="w-100">
                                ...
                                @enderror
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="date" id="ab_datepicker_examdate" name="exam_date" placeholder="Select a date" class="form-control mb-2" value="{{$language->exam_date}}" />
                                        <!--end::Input-->
                                        @error('exam_date')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            ...
                            <div class="w-100">
                                ...
                                @enderror
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="date" id="ab_datepicker_examdate" name="exam_date" placeholder="Select a date" class="form-control mb-2" value="" />
                                        @error('exam_date')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                        <!--end::Input-->
