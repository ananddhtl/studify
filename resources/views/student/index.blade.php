        ...
        <div class="w-100">
            ...
            <div class="fv-row mb-10">
                ...
                <input type="email" name="email" id="email"
                    class="form-control form-control-lg form-control-solid" value="{{ $student->email }}" />
                @error('email')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                <!--end::Input-->
            ...
            <div class="row fv-row mb-10">
                ...
                <div class="col-6">
                    ...
                    <input type="date" id="ab_datepicker_dob" name="dob" placeholder="Select a date"
                        class="form-control mb-2" value="{{ $student->dob }}" />
                ...
                <div class="col-6">
                    ...
                    <select id="birth_place_country" name="country" class="form-select"
    ...
    <form method="POST" action="{{ url('student/updateAddress') }}" accept-charset="UTF-8"
        ...
        <div class="w-100">
            ...
            <div class="fv-row mb-10">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input name="id" type="hidden" id="street_name" class=""
                    value="{{ $student->id }}" />
            ...
            <div class="knowledge_skill_exam_id">
                ...
                <div class="row fv-row mb-10">
                    ...
                    <div class="col-6">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="date" id="ab_datepicker_examdate" name="exam_date"
                            placeholder="Select a date" class="form-control mb-2"
