                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img class="img-responsive1" src="{{ asset('StudentImage/' . $student->student_img) }}"
                                    alt="Invalid Files" title="Invalid Files">
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        @if ($student)
                                            <a href="#"
                                                class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $student->first_name }}</a>
                                        @else
                                            <a href="#"
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            @if ($student)
                                <a href="#"
                                    class="fw-bold fs-6 text-gray-800 text-hover-primary">{{ $student->gender }}</a>
                            @else
