                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        @if($student)
                                        <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{$student->first_name}}</a>
                                      @else
...
<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary mb-2">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="bg-white border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="0" data-kt-countup-prefix="">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-bold fs-6 text-gray-400">Colleges Applied</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                                        <!--begin::Stat-->
                                        <div class="bg-white border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="0">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-header cursor-pointer">
                    ...
                    <!--end::Card title-->
                    <!--begin::Action-->
                    <a href="{{url('student/profile')}}" class="btn btn-primary align-self-center">Edit Profile</a>
                    <!--end::Action-->
                </div>
                <!--begin::Card header-->
                <!--begin::Card body-->
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            @if($student)
                            <span class="fw-bolder fs-6 text-gray-800">{{$student->first_name}}</span>
                            @else
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 fv-row">
                            @if($student)
                            <span class="fw-bold text-gray-800 fs-6">{{$student->email}}</span>
                            @else
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 fv-row">
                            @if($address)
                            <span class="fw-bold text-gray-800 fs-6">{{$address->street_name}}</span>
                            @else
                            <span class="fw-bold text-gray-800 fs-6"></span>
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            @if($student)
                            <span class="fw-bolder fs-6 text-gray-800 me-2">{{$student->phone}}</span>
                            @else
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            @if($student)
                            <a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">{{$student->gender}}</a>
                        @else
                            <a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary"></a>
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            @if($student)
                            <span class="fw-bolder fs-6 text-gray-800">{{$student->dob}}</span>
                            @else
                         <span class="fw-bolder fs-6 text-gray-800"></span>
