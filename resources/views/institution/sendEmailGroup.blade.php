...
<div class="row">
    ...
    <h2 class="sem">Get more SMS please click on this link.<a href="{{url('institution/email-package')}}" style="color: blue"> Get More?</a></h2>
...
<form id="First" method="POST" action="{{url('institution/email')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
...
@csrf                         
    ...
    <form id="Second" method="POST" action="{{url('institution/send-email-group')}}" accept-charset="UTF-8" class="card-body py-20 w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
...
<script>
    ...
    $('#template').on('change', function() {
           ...
           $.ajax({ 
               type: "GET", 
               dataType: "json", 
               url: '/institution/get-email-template-data', 
                    ...
                    success: function (res) {
                        ...
                        $.each(res.members, function (key, value) {
                            ...
                            $("#member").append('<option value="' + value
                                .email + '">' + value.institution_name + '</option>');
                        });
                    }
                });
              }else{
