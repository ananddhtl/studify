...
@endif
 ...
 <div class="table-responsive">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                      ...
                                      @foreach($smsgroup as $groups)
                                       ...
                                       <td>{{$groups->type}}</td>
                                       <td><a href="{{url('/institution/add-sms-group-members/'.$groups->id)}}" title="Add Members"><i style="color:green;" class="fa fa-users" aria-hidden="true"></i></a></td>
                                   </tr>
                                   @endforeach
    ...
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content" id="width8" style="height: 470px;">
        <div class="modal-header">
          ...
          <form method="POST" action="{{url('institution/add-sms-group')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
            @csrf
                               <div class="w-100">
                                <!--begin::Heading-->
