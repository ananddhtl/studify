...
@endif
                            ...
                            <div class="card-body">
                             ...
                             <a class=""  onclick="return confirm('Are you sure you want to delete this ?');" href="{{url('/institution/delete-email-template/'.$addEmailTemplates->id)}}"><i  style="color:red" class="fa fa-trash" aria-hidden="true" id="icn"></i></a>   </td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="width: 100%;">
        ...
        <form method="POST" action="{{url('/institution/update-email-template')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data" style="margin-top: 10%;">
            @csrf
 ...
 <div style="display:none;" class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="width: 100%;">
        ...
        <form method="POST" action="{{url('/institution/add-email-template')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data" style="margin-top: 10%;">
            @csrf
                               <div class="w-100" id="top">
                                <!--begin::Heading-->
...
$(document).on('click', '.editicon', function(e) {
        ...
        $.ajax({
          url: '{{ url('/institution/edit-email-template')}}',
          method: 'get',
          data: {
             id: id,
            _token: '{{ csrf_token() }}'
