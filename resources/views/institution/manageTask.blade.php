                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <tr>
                             <a href="#" ><button style="float: right;" data-toggle="modal" data-target="#Mymodal" class="add"><i class="fa fa-plus" aria-hidden="true" id="icn"></i>Add Task</button>
                             </a>
		...
		<div class="modal-content" id="taskbody">
            ...
            <h3> Add Task </h3>
				<button type="button" class="close" data-dismiss="modal">&times;</button> 
			      ...
			      <form method="POST" action="{{url('/institution/add-task')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
                  @csrf            
                  <div class="w-100">
                                <!--begin::Heading-->
                                ...
                                <div class="row fv-row mb-10">
                                   ...
                                   <select class="form-select" id="Crd" name="staff" aria-label="Default select example">
		...
		<div class="modal-content" id="taskbody">
            ...
            <h3> Update Task </h3>
				...
				<button type="button" class="close" data-dismiss="modal">&times;</button> 
			      ...
			      <form method="POST" action="{{url('institution/update-task')}}" accept-charset="UTF-8" class="card-body w-100 w-xl-700px x-9 fv-plugins-bootstrap5 fv-plugins-framework" id="application_manager_form" novalidate="novalidate" enctype="multipart/form-data">
                  @csrf            
                  <div class="w-100">
                    <input type="hidden" value="" id="id" name="id">
                                ...
                                <div class="row fv-row mb-10">
                                   ...
                                   <select class="form-control form-control-lg form-control-solid form-select" id="staff" name="staff" aria-label="Default select example">
                                   <option selected>Select Member</option>
                                   @foreach($staff as $staffs)
                                  <option value="{{$staffs->id}}">{{$staffs->name}}</option>
                                   @endforeach
    ...
    $('.support').on('change', function() {
       ...
       alert(user_id)
        $.ajax({
            type: "GET",
            dataType: "json",
            url: '/institution/changeTaskStatus',
