                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">New Applications</strong>
...
@endif
                            ...
                            <div class="card-body">
                              ...
                              <thead>
                                    ...
                                    <a class="" title="Resolve this application" href="{{url('/institution/recheck-application/'.$user->id)}}"><i class="fa fa-undo" aria-hidden="true" id="undo"></i></a>
                                    <a class="" onclick="return confirm('Are you sure');" title="Complete this application" href="{{url('/institution/complete-application/'.$user->id)}}"><i class="fa fa-check" aria-hidden="true" id="check3"></i></a>
