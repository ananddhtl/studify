...
@foreach($package as $packages)
    ...
    margin-bottom: 8px;">
                                ...
                                <div class="fix"><a class="serach-btn" href="{{url('/institution/sms-package/payment/'.$packages->id)}}" style="border: 0px; margin-top: 5px; display: block; padding: 10px;" id="nw-add">Buy</a>
    ...
    margin-bottom: 8px;">
                                ...
                                <div class="fix"><a class="serach-btn" href="{{url('/institution/sms-package/payment/'.$nepalpackages->id)}}" style="border: 0px; margin-top: 5px; display: block; padding: 10px;" id="nw-add">Buy</a>
