...
<div class="container" id="serc">
    ...
    <div class="col-md-12">
      <p class="category">Please select  package</p>
      <!-- Nav tabs -->
      <div class="card">
...
@foreach($package as $packages)
    ...
    margin-bottom: 8px;">
                                ...
                                <p style="font-size:13px; margin:0px;">
                                    ...
                                    Storage Limit: {{$packages->storage_limit}}                                    </p>
                                ...
                                <div class="fix"><a class="serach-btn" href="{{url('/institution/storage-package/payment/'.$packages->id)}}" style="border: 0px; margin-top: 5px; display: block; padding: 10px;" id="nw-add">Buy</a>
    ...
    margin-bottom: 8px;">
                                ...
                                <p style="font-size:13px; margin:0px;">
                                    <i style="font-size:12px" class="fas"></i>
                                    Storage Limit: {{$nepalpackages->storage_limit}}                                 </p>
                                ...
                                <div class="fix"><a class="serach-btn" href="{{url('/institution/storage-package/payment/'.$nepalpackages->id)}}" style="border: 0px; margin-top: 5px; display: block; padding: 10px;" id="nw-add">Buy</a>
