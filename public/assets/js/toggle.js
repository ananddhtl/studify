...
//passport file uploader
var myDropzone = new Dropzone("#ab_upload_passport", {
    url: "something.php", // Set the url for your upload script location
...
var myDropzone = new Dropzone("#upload_resume", {
...
var myDropzone3 = new Dropzone("#upload_rec_letter", {
    url: "#", // Set the url for your upload script location
    paramName: "file", // The name that will be used to transfer the file
    maxFiles: 10,
    maxFilesize: 10, // MB
...
var myDropzone1 = new Dropzone("#upload_misc", {
    url: "#", // Set the url for your upload script location
    paramName: "file", // The name that will be used to transfer the file
    maxFiles: 10,
    maxFilesize: 10, // MB
...
var myDropzone2 = new Dropzone("#upload_work_exp", {
    url: "#", // Set the url for your upload script location
    paramName: "file", // The name that will be used to transfer the file
    maxFiles: 10,
    maxFilesize: 10, // MB
...
var myDropzone2 = new Dropzone("#upload_marksheets", {
    url: "#", // Set the url for your upload script location
    paramName: "file", // The name that will be used to transfer the file
    maxFiles: 10,
    maxFilesize: 10, // MB
...
var KTFormRepeaterBasic = function() {
    // Private functions
    var schoolFormRepeater = function() {
        $('#ed_info_repeater').repeater({
            initEmpty: false,
